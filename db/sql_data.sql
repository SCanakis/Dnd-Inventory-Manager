...
-- Start of Manually Entered Section:
...
-- End of Manually Entered Section
...
INSERT INTO item_catalog (
    ...
    'Alms box', 'A small box for alms, typically found in a priest''s pack.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Antitoxin (vial)', 'A creature that drinks this vial of liquid gains advantage on saving throws against poison for 1 hour. It confers no benefit to undead or constructs.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Barding: Breastplate', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 40.0, 1600, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Barding: Chain mail', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 110.0, 300, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Barding: Chain shirt', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 40.0, 200, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Barding: Half plate', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 80.0, 3000, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Barding: Hide', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 24.0, 40, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Barding: Leather', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 20.0, 40, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Barding: Padded', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 16.0, 20, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Barding: Plate', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 130.0, 6000, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Barding: Ring mail', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 80.0, 12, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Barding: Scale mail', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 90.0, 200, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Barding: Splint', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 120.0, 800, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Barding: Studded Leather', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 26.0, 180, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Block and tackle', 'A set of pulleys with a cable threaded through them and a hook to attach to objects, a block and tackle allows you to hoist up to four times the weight you can normally lift.', 5.0, 1.0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Block of incense', 'A block of incense, typically found in a priest''s pack.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Book', 'A book might contain poetry, historical accounts, information pertaining to a particular field of lore, diagrams and notes on gnomish contraptions, or just about anything else that can be represented using text or pictures. A book of spells is a spellbook (described later in this section).', 5.0, 25, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Brewer''s Supplies', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 9.0, 20, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Candle', 'For 1 hour, a candle sheds bright light in a 5-foot radius and dim light for an additional 5 feet.', 0.0, 0.01, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Case, crossbow bolt', 'This wooden case can hold up to twenty crossbow bolts.', 1.0, 1.0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, NULL
...
INSERT INTO item_catalog (
    ...
    'Case, map or scroll', 'This cylindrical leather case can hold up to ten rolled-up sheets of paper or five rolled-up sheets of parchment.', 1.0, 1, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, NULL
...
INSERT INTO item_catalog (
    ...
    'Censer', 'A censer, typically found in a priest''s pack.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Chain (10 feet)', 'A chain has 10 hit points. It can be burst with a successful DC 20 Strength check.', 10.0, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Component pouch', 'A component pouch is a small, watertight leather belt pouch that has compartments to hold all the material components and other special items you need to cast your spells, except for those components that have a specific cost (as indicated in a spell''s description).', 2.0, 25, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Crowbar', 'Using a crowbar grants advantage to Strength checks where the crowbar''s leverage can be applied.', 5.0, 2, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Crystal', 'An arcane focus is a special item--an orb, a crystal, a rod, a specially constructed staff, a wand-like length of wood, or some similar item--designed to channel the power of arcane spells. A sorcerer, warlock, or wizard can use such an item as a spellcasting focus.', 1.0, 10, 
    False, NULL, NULL, True, 
    False, '{spellfocus}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Disguise Kit', 'This pouch of cosmetics, hair dye, and small props lets you create disguises that change your physical appearance. Proficiency with this kit lets you add your proficiency bonus to any ability checks you make to create a visual disguise.', 3.0, 25, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Fishing tackle', 'This kit includes a wooden rod, silken line, corkwood bobbers, steel hooks, lead sinkers, velvet lures, and narrow netting.', 4.0, 1.0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Flute', 'Several of the most common types of musical instruments are shown on the table as examples. If you have proficiency with a given musical instrument, you can add your proficiency bonus to any ability checks you make to play music with the instrument. A bard can use a musical instrument as a spellcasting focus. Each type of musical instrument requires a separate proficiency.', 1.0, 2, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Glassblower''s Tools', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 5.0, 30, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Healer''s Kit', 'This kit is a leather pouch containing bandages, salves, and splints. The kit has ten uses. As an action, you can expend one use of the kit to stabilize a creature that has 0 hit points, without needing to make a Wisdom (Medicine) check.', 3.0, 5.0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Lamp', 'A lamp casts bright light in a 15-foot radius and dim light for an additional 30 feet. Once lit, it burns for 6 hours on a flask (1 pint) of oil.', 1.0, 0.5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Lance', 'You have disadvantage when you use a lance to attack a target within 5 feet of you. Also, a lance requires two hands to wield when you aren''t mounted.', 6.0, 10, 
    True, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Lantern, bullseye', 'A bullseye lantern casts bright light in a 60-foot cone and dim light for an additional 60 feet. Once lit, it burns for 6 hours on a flask (1 pint) of oil.', 2.0, 10, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Lantern, hooded', 'A hooded lantern casts bright light in a 30-foot radius and dim light for an additional 30 feet. Once lit, it burns for 6 hours on a flask (1 pint) of oil. As an action, you can lower the hood, reducing the light to dim light in a 5-foot radius.', 2.0, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Little bag of sand', 'A small bag of sand, typically found in a scholar''s pack.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Lock', 'A key is provided with the lock. Without the key, a creature proficient with thieves'' tools can pick this lock with a successful DC 15 Dexterity check. Your GM may decide that better locks are available for higher prices.', 1.0, 10, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Mess Kit', 'This tin box contains a cup and simple cutlery. The box clamps together, and one side can be used as a cooking pan and the other as a plate or shallow bowl.', 1.0, 0.2, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Orb', 'An arcane focus is a special item--an orb, a crystal, a rod, a specially constructed staff, a wand-like length of wood, or some similar item--designed to channel the power of arcane spells. A sorcerer, warlock, or wizard can use such an item as a spellcasting focus.', 3.0, 20, 
    False, NULL, NULL, True, 
    False, '{spellfocus}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Painter''s Supplies', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 5.0, 10, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Poisoner''s Kit', 'A poisoner''s kit includes the vials, chemicals, and other equipment necessary for the creation of poisons. Proficiency with this kit lets you add your proficiency bonus to any ability checks you make to craft or use poisons.', 2.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Pouch', 'A cloth or leather pouch can hold up to 20 sling bullets or 50 blowgun needles, among other things. A compartmentalized pouch for holding spell components is called a component pouch (described earlier in this section).', 1.0, 0.5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, 5
...
INSERT INTO item_catalog (
    ...
    'Quiver', 'A quiver can hold up to 20 arrows.', 1.0, 1, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, NULL
...
INSERT INTO item_catalog (
    ...
    'Ram, portable', 'You can use a portable ram to break down doors. When doing so, you gain a +4 bonus on the Strength check. One other character can help you use the ram, giving you advantage on this check.', 35.0, 4.0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Rations (1 day)', 'Rations consist of dry foods suitable for extended travel, including jerky, dried fruit, hardtack, and nuts.', 2.0, 0.5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Rod', 'An arcane focus is a special item--an orb, a crystal, a rod, a specially constructed staff, a wand-like length of wood, or some similar item--designed to channel the power of arcane spells. A sorcerer, warlock, or wizard can use such an item as a spellcasting focus.', 2.0, 10, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Rope, hempen (50 feet)', 'Rope, whether made of hemp or silk, has 2 hit points and can be burst with a DC 17 Strength check.', 10.0, 1.0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Rope, silk (50 feet)', 'Rope, whether made of hemp or silk, has 2 hit points and can be burst with a DC 17 Strength check.', 5.0, 10, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Saddle, Exotic', 'An exotic saddle is required for riding any aquatic or flying mount.', 50.0, 60, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Saddle, Military', 'A military saddle braces the rider, helping you keep your seat on an active mount in battle. It gives you advantage on any check you make to remain mounted.', 30.0, 20, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Scale, merchant''s', 'A scale includes a small balance, pans, and a suitable assortment of weights up to 2 pounds. With it, you can measure the exact weight of small objects, such as raw precious metals or trade goods, to help determine their worth.', 3.0, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Shawm', 'Several of the most common types of musical instruments are shown on the table as examples. If you have proficiency with a given musical instrument, you can add your proficiency bonus to any ability checks you make to play music with the instrument. A bard can use a musical instrument as a spellcasting focus. Each type of musical instrument requires a separate proficiency.', 1.0, 2, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Small knife', 'A small knife, typically found in a scholar''s pack.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Spellbook', 'Essential for wizards, a spellbook is a leather-bound tome with 100 blank vellum pages suitable for recording spells.', 3.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Spyglass', 'Objects viewed through a spyglass are magnified to twice their size.', 1.0, 1000, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Staff', 'An arcane focus is a special item--an orb, a crystal, a rod, a specially constructed staff, a wand-like length of wood, or some similar item--designed to channel the power of arcane spells. A sorcerer, warlock, or wizard can use such an item as a spellcasting focus.', 4.0, 5, 
    False, NULL, NULL, True, 
    False, '{spellfocus}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'String (10 feet)', 'A 10-foot length of string, typically found in a burglar''s pack.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Tent, two-person', 'A simple and portable canvas shelter, a tent sleeps two.', 20.0, 2, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Thieves'' Tools', 'This set of tools includes a small file, a set of lock picks, a small mirror mounted on a metal handle, a set of narrow-bladed scissors, and a pair of pliers. Proficiency with these tools lets you add your proficiency bonus to any ability checks you make to disarm traps or open locks.', 1.0, 25, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Tinderbox', 'This small container holds flint, fire steel, and tinder (usually dry cloth soaked in light oil) used to kindle a fire. Using it to light a torch--or anything else with abundant, exposed fuel--takes an action. Lighting any other fire takes 1 minute.', 1.0, 0.5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Torch', 'A torch burns for 1 hour, providing bright light in a 20-foot radius and dim light for an additional 20 feet. If you make a melee attack with a burning torch and hit, it deals 1 fire damage.', 1.0, 0.01, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Totem', 'A druidic focus might be a sprig of mistletoe or holly, a wand or scepter made of yew or another special wood, a staff drawn whole out of a living tree, or a totem object incorporating feathers, fur, bones, and teeth from sacred animals. A druid can use such an object as a spellcasting focus.', 0.0, 1.0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Vestments', 'Religious clothing, typically found in a priest''s pack.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Wand', 'An arcane focus is a special item--an orb, a crystal, a rod, a specially constructed staff, a wand-like length of wood, or some similar item--designed to channel the power of arcane spells. A sorcerer, warlock, or wizard can use such an item as a spellcasting focus.', 1.0, 10, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Weaver''s Tools', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 5.0, 1, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Adamantine Armor', 'Armor (medium or heavy, but not hide), uncommon This suit of armor is reinforced with adamantine, one of the hardest substances in existence. While you''re wearing it, any critical hit against you becomes a normal hit.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ammunition, +1, +2, or +3', 'Weapon (any ammunition), uncommon (+1), rare (+2), or very rare (+3) You have a bonus to attack and damage rolls made with this piece of magic ammunition. The bonus is determined by the rarity of the ammunition. Once it hits a target, the ammunition is no longer magical.', 0.0, 0, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ammunition, +1', 'Weapon (any ammunition), uncommon You have a +1 bonus to attack and damage rolls made with this piece of magic ammunition. Once it hits a target, the ammunition is no longer magical.', 0.0, 0, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ammunition, +2', 'Weapon (any ammunition), rare You have a +2 bonus to attack and damage rolls made with this piece of magic ammunition. Once it hits a target, the ammunition is no longer magical.', 0.0, 0, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ammunition, +3', 'Weapon (any ammunition), very rare You have a +3 bonus to attack and damage rolls made with this piece of magic ammunition. Once it hits a target, the ammunition is no longer magical.', 0.0, 0, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Amulet of Health', 'Wondrous item, rare (requires attunement) Your Constitution score is 19 while you wear this amulet. It has no effect on you if your Constitution is already 19 or higher', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Amulet of Proof against Detection and Location', 'Wondrous item, uncommon (requires attunement) While wearing this amulet, you are hidden from divination magic. You can''t be targeted by such magic or perceived through magical scrying sensors.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Armor, +1, +2, or +3', 'Armor (light, medium, or heavy), rare (+1), very rare (+2), or legendary (+3) You have a bonus to AC while wearing this armor. The bonus is determined by its rarity.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Armor, +1', 'Armor (light, medium, or heavy), rare You have a +1 bonus to AC while wearing this armor.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Armor, +2', 'Armor (light, medium, or heavy), very rare You have a +2 bonus to AC while wearing this armor.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Armor, +3', 'Armor (light, medium, or heavy), legendary You have a +3 bonus to AC while wearing this armor.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Belt of Cloud Giant Strength', 'Wondrous item, legendary (requires attunement) While wearing this belt, your Strength score changes to 27. If your Strength is already equal to or greater than the belt''s score, the item has no Effect on you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{belt}', NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Belt of Fire Giant Strength', 'Wondrous item, very rare (requires attunement) While wearing this belt, your Strength score changes to 25. If your Strength is already equal to or greater than the belt''s score, the item has no Effect on you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{belt}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Belt of Frost Giant Strength', 'Wondrous item, very rare (requires attunement) While wearing this belt, your Strength score changes to 23. If your Strength is already equal to or greater than the belt''s score, the item has no Effect on you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{belt}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Belt of Hill Giant Strength', 'Wondrous item, rare (requires attunement) While wearing this belt, your Strength score changes to a 21. If your Strength is already equal to or greater than the belt''s score, the item has no Effect on you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{belt}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Belt of Stone Giant Strength', 'Wondrous item, very rare (requires attunement) While wearing this belt, your Strength score changes to a 23. If your Strength is already equal to or greater than the belt''s score, the item has no Effect on you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{belt}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Belt of Storm Giant Strength', 'Wondrous item, legendary (requires attunement) While wearing this belt, your Strength score changes to 29. If your Strength is already equal to or greater than the belt''s score, the item has no Effect on you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{belt}', NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Boots of Elvenkind', 'Wondrous item, uncommon While you wear these boots, your steps make no sound, regardless of the surface you are moving across. You also have advantage on Dexterity (Stealth) checks that rely on moving silently.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{feet}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Boots of Levitation', 'Wondrous item, rare (requires attunement) While you wear these boots, you can use an action to cast the levitate spell on yourself at will.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{feet}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Bracers of Archery', 'Wondrous item, uncommon (requires attunement) While wearing these bracers, you have proficiency with the longbow and shortbow, and you gain a +2 bonus to damage rolls on ranged attacks made with such weapons.', 0.0, 0, 
    True, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Bracers of Defense', 'Wondous item, rare (requires attunement) While wearing these bracers, you gain a +2 bonus to AC if you are wearing no armor and using no shield.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{bracers}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Brooch of Shielding', 'Wondrous item, uncommon (requires attunement) While wearing this brooch, you have resistance to force damage, and you have immunity to damage from the magic missile spell.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Circlet of Blasting', 'Wondrous item, uncommon While wearing this circlet, you can use an action to cast the scorching ray spell with it. When you make the spell''s attacks, you do so with an attack bonus of +5. The circlet can''t be used this way again until the next dawn.', 0.0, 0, 
    True, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Cloak of Protection', 'Wondrous item, uncommon (requires attunement) You gain a +1 bonus to AC and saving throws while you wear this cloak.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{cloak}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Cloak of the Manta Ray', 'Wondrous item, uncommon While wearing this cloak with its hood up, you can breathe underwater, and you have a swimming speed of 60 feet. Pulling the hood up or down requires an action.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{cloak}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Dwarven Plate', 'Armor (plate), very rare While wearing this armor, you gain a +2 bonus to AC. In addition, if an effect moves you against your will along the ground, you can use your reaction to reduce the distance you are moved by up to 10 feet.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Air Elemental Gem', 'Wondrous item, uncommon This blue sapphire contains a mote of elemental energy. When you use an action to break the gem, an air elemental is summoned as if you had cast the conjure elemental spell, and the gem''s magic is lost.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Earth Elemental Gem', 'Wondrous item, uncommon This yellow diamond contains a mote of elemental energy. When you use an action to break the gem, an earth elemental is summoned as if you had cast the conjure elemental spell, and the gem''s magic is lost.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Fire Elemental Gem', 'Wondrous item, uncommon This red corundum contains a mote of elemental energy. When you use an action to break the gem, a fire elemental is summoned as if you had cast the conjure elemental spell, and the gem''s magic is lost.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Water Elemental Gem', 'Wondrous item, uncommon This emerald contains a mote of elemental energy. When you use an action to break the gem, a water elemental is summoned as if you had cast the conjure elemental spell, and the gem''s magic is lost.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Elven Chain', 'Armor (chain shirt), rare You gain a +1 bonus to AC while you wear this armor. You are considered proficient with this armor even if you lack proficiency with medium armor.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Anchor Feather Token', 'Wondrous item, rare This tiny object looks like a feather. You can use an action to touch the token to a boat or ship. For the next 24 hours, the vessel can''t be moved by any means. Touching the token to the vessel again ends the effect. When the effect ends, the token disappears.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Gauntlets of Ogre Power', 'Wondrous item, uncommon (requires attunement) Your Strength score is 19 while you wear these gauntlets. They have no effect on you if your Strength is already 19 or higher.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Gem of Seeing', 'Wondrous item, rare (requires attunement) This gem has 3 charges. As an action, you can speak the gem''s command word and expend 1 charge. For the next 10 minutes, you have truesight out to 120 feet when you peer through the gem. The gem regains 1d3 expended charges daily at dawn.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Gloves of Swimming and Climbing', 'Wondrous item, uncommon (requires attunement) While wearing these gloves, climbing and swimming don''t cost you extra movement, and you gain a +5 bonus to Strength (Athletics) checks made to climb or swim.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Goggles of Night', 'Wondrous item, uncommon While wearing these dark lenses, you have darkvision out to a range of 60 feet. If you already have darkvision, wearing the goggles increases its range by 60 feet.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Hat of Disguise', 'Wondrous item, uncommon (requires attunement) While wearing this hat, you can use an action to cast the disguise self spell from it at will. The spell ends if the hat is removed.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{head}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Headband of Intellect', 'Wondrous item, uncommon (requires attunement) Your Intelligence score is 19 while you wear this headband. It has no effect on you if your Intelligence is already 19 or higher.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Helm of Comprehending Languages', 'Wondrous item, uncommon While wearing this helm, you can use an action to cast the comprehend languages spell from it at will.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Helm of Teleportation', 'Wondrous item, rare (requires attunement) This helm has 3 charges. While wearing it, you can use an action and expend 1 charge to cast the teleport spell from it. The helm regains 1d3 expended charges daily at dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Horseshoes of Speed', 'Wondrous item, rare These iron horseshoes come in a set of four. While all four shoes are affixed to the hooves of a horse or similar creature, they increase the creature''s walking speed by 30 feet.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Mantle of Spell Resistance', 'Wondrous item, rare (requires attunement) You have advantage on saving throws against spells while you wear this cloak.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Medallion of Thoughts', 'Wondrous item, uncommon (requires attunement) The medallion has 3 charges. While wearing it, you can use an action and expend 1 charge to cast the detect thoughts spell (save DC 13) from it. The medallion regains 1d3 expended charges daily at dawn.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Mithral Armor', 'Armor (medium or heavy), uncommon Mithral is a light, flexible metal. A mithral chain shirt or breastplate can be worn under normal clothes. If the armor normally imposes disadvantage on Dexterity (Stealth) checks or has a Strength requirement, the mithral version of the armor doesn''t.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Periapt of Health', 'Wondrous item, uncommon You are immune to contracting any disease while you wear this pendant. If you are already infected with a disease, the effects of the disease are suppressed you while you wear the pendant.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Periapt of Proof against Poison', 'Wondrous item, rare This delicate silver chain has a brilliant-cut black gem pendant. While you wear it, poisons have no effect on you. You are immune to the poisoned condition and have immunity to poison damage.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Periapt of Wound Closure', 'Wondrous item, uncommon (requires attunement) While you wear this pendant, you stabilize whenever you are dying at the start of your turn. In addition, whenever you roll a Hit Die to regain hit points, double the number of hit points it restores.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Animal Friendship', 'Potion, uncommon When you drink this potion, you can cast the animal friendship spell (save DC 13) for 1 hour at will. Agitating this muddy liquid brings little bits into view: a fish scale, a hummingbird tongue, a cat claw, or a squirrel hair.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Clairvoyance', 'Potion, rare When you drink this potion, you gain the effect of the clairvoyance spell. An eyeball bobs in this yellowish liquid but vanishes when the potion is opened.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Gaseous Form', 'Potion, rare When you drink this potion, you gain the effect of the gaseous form spell for 1 hour (no concentration required) or until you end the effect as a bonus action. This potion''s container seems to hold fog that moves and pours like water.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Fire Giant Strength', 'Potion, rare When you drink this potion, your Strength score changes to 25 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score. This potion''s transparent liquid has floating in it a sliver of fingernail from a fire giant.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Greater Healing', 'Potion, uncommon You regain 4d4 + 4 hit points when you drink this potion. The potion''s red liquid glimmers when agitated.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Superior Healing', 'Potion, rare You regain 8d4 + 8 hit points when you drink this potion. The potion''s red liquid glimmers when agitated.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Supreme Healing', 'Potion, very rare You regain 10d4 + 20 hit points when you drink this potion. The potion''s red liquid glimmers when agitated.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Heroism', 'Potion, rare For 1 hour after drinking it, you gain 10 temporary hit points that last for 1 hour. For the same duration, you are under the effect of the bless spell (no concentration required). This blue potion bubbles and steams as if boiling.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Invisibility', 'Potion, very rare This potion''s container looks empty but feels as though it holds liquid. When you drink it, you become invisible for 1 hour. Anything you wear or carry is invisible with you. The effect ends early if you attack or cast a spell.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Mind Reading', 'Potion, rare When you drink this potion, you gain the effect of the detect thoughts spell (save DC 13). The potion''s dense, purple liquid has an ovoid cloud of pink floating in it.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Acid Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to acid damage for 1 hour.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Cold Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to cold damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Fire Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to fire damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Force Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to force damage for 1 hour.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Lightning Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to lightning damage for 1 hour.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Necrotic Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to necrotic damage for 1 hour.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Poison Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to poison damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Psychic Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to psychic damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Radiant Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to radiant damage for 1 hour.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Thunder Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to thunder damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Speed', 'Potion, very rare When you drink this potion, you gain the effect of the haste spell for 1 minute (no concentration required). The potion''s yellow fluid is streaked with black and swirls on its own.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Potion of Water Breathing', 'Potion, uncommon You can breathe underwater for 1 hour after drinking this potion. Its cloudy green fluid smells of the sea and has a jellyfish-like bubble floating in it.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Evasion', 'Ring, rare (requires attunement) This ring has 3 charges, and it regains 1d3 expended charges daily at dawn. When you fail a Dexterity saving throw while wearing it, you can use your reaction to expend 1 of its charges to succeed on that saving throw instead.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Feather Falling', 'Ring, rare (requires attunement) When you fall while wearing this ring, you descend 60 feet per round and take no damage from falling.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Free Action', 'Ring, rare (requires attunement) While you wear this ring, difficult terrain doesn''t cost you extra movement. In addition, magic can neither reduce your speed nor cause you to be paralyzed or restrained.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Jumping', 'Ring, uncommon (requires attunement) While wearing this ring, you can cast the jump spell from it as a bonus action at will, but can target only yourself when you do so.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Protection', 'Ring, rare (requires attunement) You gain a +1 bonus to AC and saving throws while wearing this ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{ring}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Acid Resistance', 'Ring, rare (requires attunement) You have resistance to acid damage while wearing this pearl ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{ring}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Cold Resistance', 'Ring, rare (requires attunement) You have resistance to cold damage while wearing this tourmaline ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Fire Resistance', 'Ring, rare (requires attunement) You have resistance to fire damage while wearing this garnet ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{ring}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Force Resistance', 'Ring, rare (requires attunement) You have resistance to force damage while wearing this sapphire ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{ring}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Lightning Resistance', 'Ring, rare (requires attunement) You have resistance to lightning damage while wearing this citrine ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{ring}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Necrotic Resistance', 'Ring, rare (requires attunement) You have resistance to necrotic damage while wearing this jet ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{ringl,ringr}', NULL,
    NULL, NULL, 'rare',
    False, NULL
);
...
INSERT INTO item_catalog (
    ...
    'Ring of Poison Resistance', 'Ring, rare (requires attunement) You have resistance to poison damage while wearing this amethyst ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{ring}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Psychic Resistance', 'Ring, rare (requires attunement) You have resistance to psychic damage while wearing this jade ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{ring}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Radiant Resistance', 'Ring, rare (requires attunement) You have resistance to radiant damage while wearing this topaz ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{ring}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Thunder Resistance', 'Ring, rare (requires attunement) You have resistance to thunder damage while wearing this spinel ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{ring}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Swimming', 'Ring, uncommon You have a swimming speed of 40 feet while wearing this ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Telekinesis', 'Ring, very rare (requires attunement) While wearing this ring, you can cast the telekinesis spell at will, but you can target only objects that aren''t being worn or carried.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Three Wishes', 'Ring, legendary While wearing this ring, you can use an action to expend 1 of its 3 charges to cast the wish spell from it. The ring becomes nonmagical when you use the last charge.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Warmth', 'Ring, uncommon (requires attunement) While wearing this ring, you have resistance to cold damage. In addition, you and everything you wear and carry are unharmed by temperatures as low as -50 degrees Fahrenheit.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Ring of Water Walking', 'Ring, uncommon While wearing this ring, you can stand on and move across any liquid surface as if it were solid ground.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Scimitar of Speed', 'Weapon (scimitar), very rare (requires attunement) You gain a +2 bonus to attack and damage rolls made with this magic weapon. In addition, you can make one attack with it as a bonus action on each of your turns.', 0.0, 0, 
    True, NULL, NULL, True, 
    True, '{mainhand}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Spellguard Shield', 'Armor (shield), very rare (requires attunement) While holding this shield, you have advantage on saving throws against spells and other magical effects, and spell attacks have disadvantage against you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{offhand}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Stone of Good Luck (Luckstone)', 'Wondrous item, uncommon (requires attunement) While this polished agate is on your person, you gain a +1 bonus to ability checks and saving throws.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Vicious Weapon', 'Weapon (any), rare When you roll a 20 on your attack roll with this magic weapon, your critical hit deals an extra 2d6 damage of the weapon''s type.', 0.0, 0, 
    True, NULL, NULL, True, 
    True, '{mainhand,offhand,twohand}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Wand of Magic Detection', 'Wand, uncommon This wand has 3 charges. While holding it, you can expend 1 charge as an action to cast the detect magic spell from it. The wand regains 1d3 expended charges daily at dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{spellfocus}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Wand of Secrets', 'Wand, uncommon The wand has 3 charges. While holding it, you can use an action to expend 1 of its charges, and if a secret door or trap is within 30 feet of you, the wand pulses and points at the one nearest to you. The wand regains 1d3 expended charges daily at dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{spellfocus}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Wand of the War Mage, +1, +2, or +3', 'Wand, uncommon (+1), rare (+2), or very rare (+3) (requires attunement by a spellcaster) While holding this wand, you gain a bonus to spell attack rolls determined by the wand''s rarity. In addition, you ignore half cover when making a spell attack.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Wand of the War Mage, +1', 'Wand, uncommon (requires attunement by a spellcaster) While holding this wand, you gain a +1 bonus to spell attack rolls. In addition, you ignore half cover when making a spell attack.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Wand of the War Mage, +2', 'Wand, rare (requires attunement by a spellcaster) While holding this wand, you gain a +2 bonus to spell attack rolls. In addition, you ignore half cover when making a spell attack.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Wand of the War Mage, +3', 'Wand, very rare (requires attunement by a spellcaster) While holding this wand, you gain a +3 bonus to spell attack rolls. In addition, you ignore half cover when making a spell attack.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Weapon, +1, +2, or +3', 'Weapon (any), uncommon (+1), rare (+2), or very rare (+3) You have a bonus to attack and damage rolls made with this magic weapon. The bonus is determined by the weapon''s rarity.', 0.0, 0, 
    True, NULL, NULL, True, 
    False, '{mainhand,offhand,twohand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Weapon, +1', 'Weapon (any), uncommon You have a +1 bonus to attack and damage rolls made with this magic weapon.', 0.0, 0, 
    True, NULL, NULL, True, 
    False, '{mainhand,offhand,twohand}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Weapon, +2', 'Weapon (any), rare You have a +2 bonus to attack and damage rolls made with this magic weapon.', 0.0, 0, 
    True, NULL, NULL, True, 
    True, '{mainhand,offhand,twohand}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    'Weapon, +3', 'Weapon (any), very rare You have a +3 bonus to attack and damage rolls made with this magic weapon.', 0.0, 0, 
    True, NULL, NULL, True, 
    False, '{mainhand,offhand,twohand}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
