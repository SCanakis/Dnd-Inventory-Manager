...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Acid (vial)', 'As an action, you can splash the contents of this vial onto a creature within 5 feet of you or throw the vial up to 20 feet, shattering it on impact. In either case, make a ranged attack against a creature or object, treating the acid as an improvised weapon. On a hit, the target takes 2d6 acid damage.', 1.0, 25, 
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Alms box', 'A small box for alms, typically found in a priest''s pack.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Amulet', 'A holy symbol is a representation of a god or pantheon. It might be an amulet depicting a symbol representing a deity, the same symbol carefully engraved or inlaid as an emblem on a shield, or a tiny box holding a fragment of a sacred relic. Appendix B lists the symbols commonly associated with many gods in the multiverse. A cleric or paladin can use a holy symbol as a spellcasting focus. To use the symbol in this way, the caster must hold it in hand, wear it visibly, or bear it on a shield.', 1.0, 5, 
    False, NULL, NULL, True, 
    False, '{spellfocus}', NULL,
    NULL, NULL, 'common',
    False, NULL
);
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Animal Feed (1 day)', '', 10.0, 0.05, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Antitoxin (vial)', 'A creature that drinks this vial of liquid gains advantage on saving throws against poison for 1 hour. It confers no benefit to undead or constructs.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Backpack', '', 5.0, 2, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, 30-40 lbs
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Bagpipes', 'Several of the most common types of musical instruments are shown on the table as examples. If you have proficiency with a given musical instrument, you can add your proficiency bonus to any ability checks you make to play music with the instrument. A bard can use a musical instrument as a spellcasting focus. Each type of musical instrument requires a separate proficiency.', 6.0, 30, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Barding: Breastplate', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 40.0, 1600, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Barding: Chain mail', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 110.0, 300, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Barding: Chain shirt', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 40.0, 200, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Barding: Half plate', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 80.0, 3000, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Barding: Hide', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 24.0, 40, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Barding: Leather', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 20.0, 40, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Barding: Padded', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 16.0, 20, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Barding: Plate', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 130.0, 6000, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Barding: Ring mail', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 80.0, 12, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Barding: Scale mail', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 90.0, 200, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Barding: Splint', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 120.0, 800, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Barding: Studded Leather', 'Barding is armor designed to protect an animal''s head, neck, chest, and body. Any type of armor shown on the Armor table can be purchased as barding. The cost is four times the equivalent armor made for humanoids, and it weighs twice as much.', 26.0, 180, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Basket', '', 2.0, 0.4, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Battleaxe', '', 4.0, 10, 
    True, NULL, NULL, True, 
    False, '{mainhand,twohand}', NULL,
    NULL, NULL, 'common',
    False, NULL
);
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Bedroll', '', 7.0, 1.0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Bit and bridle', '', 1.0, 2, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Blanket', '', 3.0, 0.5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Block and tackle', 'A set of pulleys with a cable threaded through them and a hook to attach to objects, a block and tackle allows you to hoist up to four times the weight you can normally lift.', 5.0, 1, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Block of incense', 'A block of incense, typically found in a priest''s pack.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Blowgun', '', 1.0, 10, 
    True, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Blowgun needle', '', 1.0, 1, 
    True, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Book', 'A book might contain poetry, historical accounts, information pertaining to a particular field of lore, diagrams and notes on gnomish contraptions, or just about anything else that can be represented using text or pictures. A book of spells is a spellbook (described later in this section).', 5.0, 25, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Bottle, glass', '', 2.0, 2, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Breastplate', '', 20.0, 400, 
    False, 14, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Brewer''s Supplies', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 9.0, 20, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Bucket', '', 2.0, 0.05, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Burglar''s Pack', '', 0.0, 16, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, 30
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Calligrapher''s Supplies', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 5.0, 10, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Candle', 'For 1 hour, a candle sheds bright light in a 5-foot radius and dim light for an additional 5 feet.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Carpenter''s Tools', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 6.0, 8, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Carriage', '', 600.0, 100, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Cartographer''s Tools', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 6.0, 15, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Case, crossbow bolt', 'This wooden case can hold up to twenty crossbow bolts.', 1.0, 1, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Case, map or scroll', 'This cylindrical leather case can hold up to ten rolled-up sheets of paper or five rolled-up sheets of parchment.', 1.0, 1, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Censer', 'A censer, typically found in a priest''s pack.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Chain (10 feet)', 'A chain has 10 hit points. It can be burst with a successful DC 20 Strength check.', 10.0, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Chain Mail', '', 55.0, 75, 
    False, 16, NULL, True, 
    False, '{armor}', '{"strength": 13}',
    NULL, NULL, 'common',
    False, NULL
);
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Chain Shirt', '', 20.0, 50, 
    False, 13, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Chalk (1 piece)', '', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Chariot', '', 100.0, 250, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Climber''s Kit', 'A climber''s kit includes special pitons, boot tips, gloves, and a harness. You can use the climber''s kit as an action to anchor yourself; when you do, you can''t fall more than 25 feet from the point where you anchored yourself, and you can''t climb more than 25 feet away from that point without undoing the anchor.', 12.0, 25, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Clothes, common', '', 3.0, 0.5, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Clothes, costume', '', 4.0, 5, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Clothes, fine', '', 6.0, 15, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Clothes, traveler''s', '', 4.0, 2, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Cobbler''s Tools', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 5.0, 5, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Component pouch', 'A component pouch is a small, watertight leather belt pouch that has compartments to hold all the material components and other special items you need to cast your spells, except for those components that have a specific cost (as indicated in a spell''s description).', 2.0, 25, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Cook''s utensils', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 8.0, 1, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Crossbow bolt', '', 1.5, 1, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Crossbow, hand', '', 3.0, 75, 
    True, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Crossbow, heavy', '', 18.0, 50, 
    True, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Crossbow, light', '', 5.0, 25, 
    True, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Crowbar', 'Using a crowbar grants advantage to Strength checks where the crowbar''s leverage can be applied.', 5.0, 2, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Crystal', 'An arcane focus is a special item--an orb, a crystal, a rod, a specially constructed staff, a wand-like length of wood, or some similar item--designed to channel the power of arcane spells. A sorcerer, warlock, or wizard can use such an item as a spellcasting focus.', 1.0, 10, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Dart', '', 0.25, 0.05, 
    True, NULL, NULL, True, 
    False, '{mainhand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Dice Set', 'This item encompasses a wide range of game pieces, including dice and decks of cards (for games such as Three-Dragon Ante). A few common examples appear on the Tools table, but other kinds of gaming sets exist. If you are proficient with a gaming set, you can add your proficiency bonus to ability checks you make to play a game with that set. Each type of gaming set requires a separate proficiency.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Diplomat''s Pack', '', 0.0, 39, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, 50
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Disguise Kit', 'This pouch of cosmetics, hair dye, and small props lets you create disguises that change your physical appearance. Proficiency with this kit lets you add your proficiency bonus to any ability checks you make to create a visual disguise.', 3.0, 25, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Drum', 'Several of the most common types of musical instruments are shown on the table as examples. If you have proficiency with a given musical instrument, you can add your proficiency bonus to any ability checks you make to play music with the instrument. A bard can use a musical instrument as a spellcasting focus. Each type of musical instrument requires a separate proficiency.', 3.0, 6, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Dulcimer', 'Several of the most common types of musical instruments are shown on the table as examples. If you have proficiency with a given musical instrument, you can add your proficiency bonus to any ability checks you make to play music with the instrument. A bard can use a musical instrument as a spellcasting focus. Each type of musical instrument requires a separate proficiency.', 10.0, 25, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Dungeoneer''s Pack', '', 0.0, 12, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, 30
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Elephant', '', 0.0, 200, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Entertainer''s Pack', '', 0.0, 40, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, 30
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Explorer''s Pack', '', 0.0, 10, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, 30
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Fishing tackle', 'This kit includes a wooden rod, silken line, corkwood bobbers, steel hooks, lead sinkers, velvet lures, and narrow netting.', 4.0, 1.0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Flask or tankard', '', 1.0, 0.02, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Forgery Kit', 'This small box contains a variety of papers and parchments, pens and inks, seals and sealing wax, gold and silver leaf, and other supplies necessary to create convincing forgeries of physical documents. Proficiency with this kit lets you add your proficiency bonus to any ability checks you make to create a physical forgery of a document.', 5.0, 15, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Galley', '', 0.0, 30000, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Grappling hook', '', 4.0, 2, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Greataxe', '', 7.0, 30, 
    True, NULL, NULL, True, 
    False, '{twohand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Greatclub', '', 10.0, 0.2, 
    True, NULL, NULL, True, 
    False, '{twohand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Greatsword', '', 6.0, 50, 
    True, NULL, NULL, True, 
    False, '{twohand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Halberd', '', 6.0, 20, 
    True, NULL, NULL, True, 
    False, '{twohand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Half Plate Armor', '', 40.0, 750, 
    False, 15, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Hammer, sledge', '', 10.0, 2, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Healer''s Kit', 'This kit is a leather pouch containing bandages, salves, and splints. The kit has ten uses. As an action, you can expend one use of the kit to stabilize a creature that has 0 hit points, without needing to make a Wisdom (Medicine) check.', 3.0, 5.0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Herbalism Kit', 'This kit contains a variety of instruments such as clippers, mortar and pestle, and pouches and vials used by herbalists to create remedies and potions. Proficiency with this kit lets you add your proficiency bonus to any ability checks you make to identify or apply herbs. Also, proficiency with this kit is required to create antitoxin and potions of healing.', 3.0, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Hide Armor', '', 12.0, 10, 
    False, 12, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Holy water (flask)', 'As an action, you can splash the contents of this flask onto a creature within 5 feet of you or throw it up to 20 feet, shattering it on impact. In either case, make a ranged attack against a target creature, treating the holy water as an improvised weapon. If the target is a fiend or undead, it takes 2d6 radiant damage. A cleric or paladin may create holy water by performing a special ritual. The ritual takes 1 hour to perform, uses 25 gp worth of powdered silver, and requires the caster to expend a 1st-level spell slot.', 1.0, 25, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Horn', 'Several of the most common types of musical instruments are shown on the table as examples. If you have proficiency with a given musical instrument, you can add your proficiency bonus to any ability checks you make to play music with the instrument. A bard can use a musical instrument as a spellcasting focus. Each type of musical instrument requires a separate proficiency.', 2.0, 3, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Horse, draft', '', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Horse, riding', '', 0.0, 75, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Hourglass', '', 1.0, 25, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Hunting trap', 'When you use your action to set it, this trap forms a saw-toothed steel ring that snaps shut when a creature steps on a pressure plate in the center. The trap is affixed by a heavy chain to an immobile object, such as a tree or a spike driven into the ground. A creature that steps on the plate must succeed on a DC 13 Dexterity saving throw or take 1d4 piercing damage and stop moving. Thereafter, until the creature breaks free of the trap, its movement is limited by the length of the chain (typically 3 feet long). A creature can use its action to make a DC 13 Strength check, freeing itself or another creature within its reach on a success. Each failed check deals 1 piercing damage to the trapped creature.', 25.0, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ink (1 ounce bottle)', '', 0.0, 10, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Javelin', '', 2.0, 0.5, 
    True, NULL, NULL, True, 
    False, '{mainhand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Jeweler''s Tools', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 2.0, 25, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Jug or pitcher', '', 4.0, 0.02, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Keelboat', 'Keelboats and rowboats are used on lakes and rivers. If going downstream, add the speed of the current (typically 3 miles per hour) to the speed of the vehicle. These vehicles can''t be rowed against any significant current, but they can be pulled upstream by draft animals on the shores. A rowboat weighs 100 pounds, in case adventurers carry it over land.', 0.0, 3000, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ladder (10-foot)', '', 25.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Lamp', 'A lamp casts bright light in a 15-foot radius and dim light for an additional 30 feet. Once lit, it burns for 6 hours on a flask (1 pint) of oil.', 1.0, 0.5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Lance', 'You have disadvantage when you use a lance to attack a target within 5 feet of you. Also, a lance requires two hands to wield when you aren''t mounted.', 6.0, 10, 
    True, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Lantern, bullseye', 'A bullseye lantern casts bright light in a 60-foot cone and dim light for an additional 60 feet. Once lit, it burns for 6 hours on a flask (1 pint) of oil.', 2.0, 10, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Lantern, hooded', 'A hooded lantern casts bright light in a 30-foot radius and dim light for an additional 30 feet. Once lit, it burns for 6 hours on a flask (1 pint) of oil. As an action, you can lower the hood, reducing the light to dim light in a 5-foot radius.', 2.0, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Leather Armor', '', 10.0, 10, 
    False, 11, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Leatherworker''s Tools', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 5.0, 5, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Light hammer', '', 2.0, 2, 
    True, NULL, NULL, True, 
    False, '{mainhand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Little bag of sand', 'A small bag of sand, typically found in a scholar''s pack.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Lock', 'A key is provided with the lock. Without the key, a creature proficient with thieves'' tools can pick this lock with a successful DC 15 Dexterity check. Your GM may decide that better locks are available for higher prices.', 1.0, 10, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Longbow', '', 2.0, 50, 
    True, NULL, NULL, True, 
    False, '{twohand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Longship', '', 0.0, 10000, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Longsword', '', 3.0, 15, 
    True, NULL, NULL, True, 
    False, '{mainhand,twohand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Lute', 'Several of the most common types of musical instruments are shown on the table as examples. If you have proficiency with a given musical instrument, you can add your proficiency bonus to any ability checks you make to play music with the instrument. A bard can use a musical instrument as a spellcasting focus. Each type of musical instrument requires a separate proficiency.', 2.0, 35, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Lyre', 'Several of the most common types of musical instruments are shown on the table as examples. If you have proficiency with a given musical instrument, you can add your proficiency bonus to any ability checks you make to play music with the instrument. A bard can use a musical instrument as a spellcasting focus. Each type of musical instrument requires a separate proficiency.', 2.0, 30, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Magnifying glass', 'This lens allows a closer look at small objects. It is also useful as a substitute for flint and steel when starting fires. Lighting a fire with a magnifying glass requires light as bright as sunlight to focus, tinder to ignite, and about 5 minutes for the fire to ignite. A magnifying glass grants advantage on any ability check made to appraise or inspect an item that is small or highly detailed.', 0.0, 100, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Manacles', 'These metal restraints can bind a Small or Medium creature. Escaping the manacles requires a successful DC 20 Dexterity check. Breaking them requires a successful DC 20 Strength check. Each set of manacles comes with one key. Without the key, a creature proficient with thieves'' tools can pick the manacles'' lock with a successful DC 15 Dexterity check. Manacles have 15 hit points.', 6.0, 2, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Mastiff', '', 0.0, 25, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Mess Kit', 'This tin box contains a cup and simple cutlery. The box clamps together, and one side can be used as a cooking pan and the other as a plate or shallow bowl.', 1.0, 0.2, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Mirror, steel', '', 0.5, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Morningstar', '', 4.0, 15, 
    True, NULL, NULL, True, 
    False, '{mainhand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Navigator''s Tools', 'This set of instruments is used for navigation at sea. Proficiency with navigator''s tools lets you chart a ship''s course and follow navigation charts. In addition, these tools allow you to add your proficiency bonus to any ability check you make to avoid getting lost at sea.', 2.0, 25, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Oil (flask)', 'Oil usually comes in a clay flask that holds 1 pint. As an action, you can splash the oil in this flask onto a creature within 5 feet of you or throw it up to 20 feet, shattering it on impact. Make a ranged attack against a target creature or object, treating the oil as an improvised weapon. On a hit, the target is covered in oil. If the target takes any fire damage before the oil dries (after 1 minute), the target takes an additional 5 fire damage from the burning oil. You can also pour a flask of oil on the ground to cover a 5-foot-square area, provided that the surface is level. If lit, the oil burns for 2 rounds and deals 5 fire damage to any creature that enters the area or ends its turn in the area. A creature can take this damage only once per turn.', 1.0, 0.1, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Orb', 'An arcane focus is a special item--an orb, a crystal, a rod, a specially constructed staff, a wand-like length of wood, or some similar item--designed to channel the power of arcane spells. A sorcerer, warlock, or wizard can use such an item as a spellcasting focus.', 3.0, 20, 
    False, NULL, NULL, True, 
    False, '{spellfocus}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Padded Armor', '', 8.0, 5, 
    False, 11, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Pan flute', 'Several of the most common types of musical instruments are shown on the table as examples. If you have proficiency with a given musical instrument, you can add your proficiency bonus to any ability checks you make to play music with the instrument. A bard can use a musical instrument as a spellcasting focus. Each type of musical instrument requires a separate proficiency.', 2.0, 12, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Paper (one sheet)', '', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Parchment (one sheet)', '', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Perfume (vial)', '', 0.0, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Pick, miner''s', '', 10.0, 2, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Piton', '', 0.25, 0.05, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Plate Armor', '', 65.0, 1500, 
    False, 18, NULL, True, 
    False, '{armor}', '{"strength": 15}',
    NULL, NULL, 'common',
    False, NULL
);
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Playing Card Set', 'This item encompasses a wide range of game pieces, including dice and decks of cards (for games such as Three-Dragon Ante). A few common examples appear on the Tools table, but other kinds of gaming sets exist. If you are proficient with a gaming set, you can add your proficiency bonus to ability checks you make to play a game with that set. Each type of gaming set requires a separate proficiency.', 0.0, 0.5, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Poisoner''s Kit', 'A poisoner''s kit includes the vials, chemicals, and other equipment necessary for the creation of poisons. Proficiency with this kit lets you add your proficiency bonus to any ability checks you make to craft or use poisons.', 2.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Pole (10-foot)', '', 7.0, 0.05, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Pot, iron', '', 10.0, 2, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potter''s Tools', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 3.0, 10, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Pouch', 'A cloth or leather pouch can hold up to 20 sling bullets or 50 blowgun needles, among other things. A compartmentalized pouch for holding spell components is called a component pouch (described earlier in this section).', 1.0, 0.5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, 5
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Priest''s Pack', '', 0.0, 19, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, 30
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Quarterstaff', '', 4.0, 0.2, 
    True, NULL, NULL, True, 
    False, '{twohand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Quiver', 'A quiver can hold up to 20 arrows.', 1.0, 1, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ram, portable', 'You can use a portable ram to break down doors. When doing so, you gain a +4 bonus on the Strength check. One other character can help you use the ram, giving you advantage on this check.', 35.0, 4.0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Rations (1 day)', 'Rations consist of dry foods suitable for extended travel, including jerky, dried fruit, hardtack, and nuts.', 2.0, 0.5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring Mail', '', 40.0, 30, 
    False, 14, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Rod', 'An arcane focus is a special item--an orb, a crystal, a rod, a specially constructed staff, a wand-like length of wood, or some similar item--designed to channel the power of arcane spells. A sorcerer, warlock, or wizard can use such an item as a spellcasting focus.', 2.0, 10, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Rope, hempen (50 feet)', 'Rope, whether made of hemp or silk, has 2 hit points and can be burst with a DC 17 Strength check.', 10.0, 1.0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Rope, silk (50 feet)', 'Rope, whether made of hemp or silk, has 2 hit points and can be burst with a DC 17 Strength check.', 5.0, 10, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Rowboat', 'Keelboats and rowboats are used on lakes and rivers. If going downstream, add the speed of the current (typically 3 miles per hour) to the speed of the vehicle. These vehicles can''t be rowed against any significant current, but they can be pulled upstream by draft animals on the shores. A rowboat weighs 100 pounds, in case adventurers carry it over land.', 100.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Saddle, Exotic', 'An exotic saddle is required for riding any aquatic or flying mount.', 50.0, 60, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Saddle, Military', 'A military saddle braces the rider, helping you keep your seat on an active mount in battle. It gives you advantage on any check you make to remain mounted.', 30.0, 20, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Saddle, Pack', '', 15.0, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Saddle, Riding', '', 25.0, 10, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Saddlebags', '', 8.0, 4, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Sailing ship', '', 0.0, 10000, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Scale Mail', '', 45.0, 50, 
    False, 14, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Scale, merchant''s', 'A scale includes a small balance, pans, and a suitable assortment of weights up to 2 pounds. With it, you can measure the exact weight of small objects, such as raw precious metals or trade goods, to help determine their worth.', 3.0, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Scholar''s Pack', '', 0.0, 40, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, 30
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Scimitar', '', 3.0, 25, 
    True, NULL, NULL, True, 
    False, '{mainhand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Sealing wax', '', 0.0, 0.5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Shortbow', '', 2.0, 25, 
    True, NULL, NULL, True, 
    False, '{twohand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Shortsword', '', 2.0, 10, 
    True, NULL, NULL, True, 
    False, '{mainhand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Signal whistle', '', 0.0, 0.05, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Signet ring', '', 0.0, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Sling bullet', '', 1.5, 0.04, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Small knife', 'A small knife, typically found in a scholar''s pack.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Smith''s Tools', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 8.0, 20, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Spellbook', 'Essential for wizards, a spellbook is a leather-bound tome with 100 blank vellum pages suitable for recording spells.', 3.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Spike, iron', '', 5.0, 0.1, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Splint Armor', '', 60.0, 200, 
    False, 17, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Spyglass', 'Objects viewed through a spyglass are magnified to twice their size.', 1.0, 1000, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Stabling (1 day)', '', 0.0, 0.5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Staff', 'An arcane focus is a special item--an orb, a crystal, a rod, a specially constructed staff, a wand-like length of wood, or some similar item--designed to channel the power of arcane spells. A sorcerer, warlock, or wizard can use such an item as a spellcasting focus.', 4.0, 5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'String (10 feet)', 'A 10-foot length of string, typically found in a burglar''s pack.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Studded Leather Armor', '', 13.0, 45, 
    False, 12, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Tent, two-person', 'A simple and portable canvas shelter, a tent sleeps two.', 20.0, 2, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Tinderbox', 'This small container holds flint, fire steel, and tinder (usually dry cloth soaked in light oil) used to kindle a fire. Using it to light a torch--or anything else with abundant, exposed fuel--takes an action. Lighting any other fire takes 1 minute.', 1.0, 0.5, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Tinker''s Tools', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 10.0, 50, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Torch', 'A torch burns for 1 hour, providing bright light in a 20-foot radius and dim light for an additional 20 feet. If you make a melee attack with a burning torch and hit, it deals 1 fire damage.', 1.0, 0.01, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Vestments', 'Religious clothing, typically found in a priest''s pack.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Viol', 'Several of the most common types of musical instruments are shown on the table as examples. If you have proficiency with a given musical instrument, you can add your proficiency bonus to any ability checks you make to play music with the instrument. A bard can use a musical instrument as a spellcasting focus. Each type of musical instrument requires a separate proficiency.', 1.0, 30, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Wagon', '', 400.0, 35, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Wand', 'An arcane focus is a special item--an orb, a crystal, a rod, a specially constructed staff, a wand-like length of wood, or some similar item--designed to channel the power of arcane spells. A sorcerer, warlock, or wizard can use such an item as a spellcasting focus.', 1.0, 10, 
    False, NULL, NULL, True, 
    False, '{spellfocus}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'War pick', '', 2.0, 5, 
    True, NULL, NULL, True, 
    False, '{mainhand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Warhammer', '', 2.0, 15, 
    True, NULL, NULL, True, 
    False, '{mainhand,twohand}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Warhorse', '', 0.0, 400, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Warship', '', 0.0, 25000, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Waterskin', '', 5.0, 0.2, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Whetstone', '', 1.0, 0.01, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Woodcarver''s Tools', 'These special tools include the items needed to pursue a craft or trade. The table shows examples of the most common types of tools, each providing items related to a single craft. Proficiency with a set of artisan''s tools lets you add your proficiency bonus to any ability checks you make using the tools in your craft. Each type of artisan''s tools requires a separate proficiency.', 5.0, 1, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Adamantine Armor', 'Armor (medium or heavy, but not hide), uncommon This suit of armor is reinforced with adamantine, one of the hardest substances in existence. While you''re wearing it, any critical hit against you becomes a normal hit.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ammunition, +1, +2, or +3', 'Weapon (any ammunition), uncommon (+1), rare (+2), or very rare (+3) You have a bonus to attack and damage rolls made with this piece of magic ammunition. The bonus is determined by the rarity of the ammunition. Once it hits a target, the ammunition is no longer magical.', 0.0, 0, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ammunition, +1', 'Weapon (any ammunition), uncommon You have a +1 bonus to attack and damage rolls made with this piece of magic ammunition. Once it hits a target, the ammunition is no longer magical.', 0.0, 0, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ammunition, +2', 'Weapon (any ammunition), rare You have a +2 bonus to attack and damage rolls made with this piece of magic ammunition. Once it hits a target, the ammunition is no longer magical.', 0.0, 0, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ammunition, +3', 'Weapon (any ammunition), very rare You have a +3 bonus to attack and damage rolls made with this piece of magic ammunition. Once it hits a target, the ammunition is no longer magical.', 0.0, 0, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Amulet of Health', 'Wondrous item, rare (requires attunement) Your Constitution score is 19 while you wear this amulet. It has no effect on you if your Constitution is already 19 or higher', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Amulet of Proof against Detection and Location', 'Wondrous item, uncommon (requires attunement) While wearing this amulet, you are hidden from divination magic. You can''t be targeted by such magic or perceived through magical scrying sensors.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Amulet of the Planes', 'Wondrous item, very rare (requires attunement) While wearing this amulet, you can use an action to name a location that you are familiar with on another plane of existence. Then make a DC 15 Intelligence check. On a successful check, you cast the plane shift spell. On a failure, you and each creature and object within 15 feet of you travel to a random destination. Roll a d100. On a 1-60, you travel to a random location on the plane you named. On a 61-100, you travel to a randomly determined plane of existence.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Animated Shield', 'Armor (shield), very rare (requires attunement) While holding this shield, you can speak its command word as a bonus action to cause it to animate. The shield leaps into the air and hovers in your space to protect you as if you were wielding it, leaving your hands free. The shield remains animated for 1 minute, until you use a bonus action to end this effect, or until you are incapacitated or die, at which point the shield falls to the ground or into your hand if you have one free.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{offhand}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Armor, +1, +2, or +3', 'Armor (light, medium, or heavy), rare (+1), very rare (+2), or legendary (+3) You have a bonus to AC while wearing this armor. The bonus is determined by its rarity.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Armor, +1', 'Armor (light, medium, or heavy), rare You have a +1 bonus to AC while wearing this armor.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Armor, +2', 'Armor (light, medium, or heavy), very rare You have a +2 bonus to AC while wearing this armor.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Armor, +3', 'Armor (light, medium, or heavy), legendary You have a +3 bonus to AC while wearing this armor.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Armor of Invulnerability', 'Armor (plate), legendary (requires attunement) You have resistance to nonmagical damage while you wear this armor. Additionally, you can use an action to make yourself immune to nonmagical damage for 10 minutes or until you are no longer wearing the armor. Once this special action is used, it can''t be used again until the next dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{armor}', NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Arrow-Catching Shield', 'Armor (shield), rare (requires attunement) You gain a +2 bonus to AC against ranged attacks while you wield this shield. This bonus is in addition to the shield''s normal bonus to AC. In addition, whenever an attacker makes a ranged attack against a target within 5 feet of you, you can use your reaction to become the target of the attack instead.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{offhand}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Gray Bag of Tricks', 'Wondrous item, uncommon This ordinary bag, made from gray cloth, appears empty. Reaching inside the bag, however, reveals the presence of a small, fuzzy object. The bag weighs 1/2 pound. You can use an action to pull the fuzzy object from the bag and throw it up to 20 feet. When the object lands, it transforms into a creature you determine by rolling a d8 and consulting the table that corresponds to the bag''s color. The creature vanishes at the next dawn or when it is reduced to 0 Hit Points. The creature is friendly to you and your companions, and it acts on Your Turn. You can use a Bonus Action to Command how the creature moves and what action it takes on its next turn, or to give it general orders, such as to Attack your enemies. In the absence of such orders, the creature acts in a fashion appropriate to its Nature. Once three fuzzy Objects have been pulled from the bag, the bag can''t be used again until the next dawn. Gray Bag: | d8 | Creature | |---|---| | 01 | Weasel | | 02 | Giant Rat | | 03 | Badger | | 04 | Boar | | 05 | Panther | | 06 | Giant Badger | | 07 | Dire Wolf | | 08 | Giant Elk |', 0.5, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    True, 10
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Rust Bag of Tricks', 'Wondrous item, uncommon This ordinary bag, made from rust cloth, appears empty. Reaching inside the bag, however, reveals the presence of a small, fuzzy object. The bag weighs 1/2 pound. You can use an action to pull the fuzzy object from the bag and throw it up to 20 feet. When the object lands, it transforms into a creature you determine by rolling a d8 and consulting the table that corresponds to the bag''s color. The creature vanishes at the next dawn or when it is reduced to 0 Hit Points. The creature is friendly to you and your companions, and it acts on Your Turn. You can use a Bonus Action to Command how the creature moves and what action it takes on its next turn, or to give it general orders, such as to Attack your enemies. In the absence of such orders, the creature acts in a fashion appropriate to its Nature. Once three fuzzy Objects have been pulled from the bag, the bag can''t be used again until the next dawn. Rust Bag: | d8 | Creature | |---|---| | 01 | Rat | | 02 | Owl | | 03 | Mastiff | | 04 | Goat | | 05 | Giant Goat | | 06 | Giant Boar | | 07 | Lion | | 08 | Brown Bear |', 0.5, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    True, 10
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Belt of Cloud Giant Strength', 'Wondrous item, legendary (requires attunement) While wearing this belt, your Strength score changes to 27. If your Strength is already equal to or greater than the belt''s score, the item has no Effect on you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{belt}', NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Belt of Fire Giant Strength', 'Wondrous item, very rare (requires attunement) While wearing this belt, your Strength score changes to 25. If your Strength is already equal to or greater than the belt''s score, the item has no Effect on you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{belt}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Belt of Frost Giant Strength', 'Wondrous item, very rare (requires attunement) While wearing this belt, your Strength score changes to 23. If your Strength is already equal to or greater than the belt''s score, the item has no Effect on you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{belt}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Belt of Hill Giant Strength', 'Wondrous item, rare (requires attunement) While wearing this belt, your Strength score changes to a 21. If your Strength is already equal to or greater than the belt''s score, the item has no Effect on you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{belt}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Belt of Stone Giant Strength', 'Wondrous item, very rare (requires attunement) While wearing this belt, your Strength score changes to a 23. If your Strength is already equal to or greater than the belt''s score, the item has no Effect on you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{belt}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Belt of Storm Giant Strength', 'Wondrous item, legendary (requires attunement) While wearing this belt, your Strength score changes to 29. If your Strength is already equal to or greater than the belt''s score, the item has no Effect on you.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{belt}', NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Boots of Elvenkind', 'Wondrous item, uncommon While you wear these boots, your steps make no sound, regardless of the surface you are moving across. You also have advantage on Dexterity (Stealth) checks that rely on moving silently.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{feet}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Boots of Levitation', 'Wondrous item, rare (requires attunement) While you wear these boots, you can use an action to cast the levitate spell on yourself at will.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{feet}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Boots of Speed', 'Wondrous item, rare (requires attunement) While you wear these boots, you can use a bonus action and click the boots'' heels together. If you do, the boots double your walking speed, and any creature that makes an opportunity attack against you has disadvantage on the attack roll. If you click your heels together again, you end the effect. When the boots'' property has been used for a total of 10 minutes, the magic ceases to function until you finish a long rest.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{feet}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Boots of Striding and Springing', 'Wondrous item, uncommon (requires attunement) While you wear these boots, your walking speed becomes 30 feet, unless your walking speed is higher, and your speed isn''t reduced if you are encumbered or wearing heavy armor. In addition, you can jump three times the normal distance, though you can''t jump farther than your remaining movement would allow.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{feet}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Bracers of Archery', 'Wondrous item, uncommon (requires attunement) While wearing these bracers, you have proficiency with the longbow and shortbow, and you gain a +2 bonus to damage rolls on ranged attacks made with such weapons.', 0.0, 0, 
    True, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Bracers of Defense', 'Wondous item, rare (requires attunement) While wearing these bracers, you gain a +2 bonus to AC if you are wearing no armor and using no shield.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{bracers}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Brooch of Shielding', 'Wondrous item, uncommon (requires attunement) While wearing this brooch, you have resistance to force damage, and you have immunity to damage from the magic missile spell.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Broom of Flying', 'Wondrous item, uncommon This wooden broom, which weighs 3 pounds, functions like a mundane broom until you stand astride it and speak its command word. It then hovers beneath you and can be ridden in the air. It has a flying speed of 50 feet. It can carry up to 400 pounds, but its flying speed becomes 30 feet while carrying over 200 pounds. The broom stops hovering when you land. You can send the broom to travel alone to a destination within 1 mile of you if you speak the command word, name the location, and are familiar with that place. The broom comes back to you when you speak another command word, provided that the broom is still within 1 mile of you.', 3.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Carpet of Flying', 'Wondrous item, very rare You can speak the carpet''s command word as an action to make the carpet hover and fly. It moves according to your spoken directions, provided that you are within 30 feet of it. Four sizes of carpet of flying exist. The GM chooses the size of a given carpet or determines it randomly. | d100 | Size | Capacity | Flying Speed | |---|---|---|---| | 01-20 | 3 ft. × 5 ft. | 200 lb. | 80 feet | | 21-55 | 4 ft. × 6 ft. | 400 lb. | 60 feet | | 56-80 | 5 ft. × 7 ft. | 600 lb. | 40 feet | | 81-100 | 6 ft. × 9 ft. | 800 lb. | 30 feet | A carpet can carry up to twice the weight shown on the table, but it flies at half speed if it carries more than its normal capacity.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Carpet of Flying (3 ft. × 5 ft.)', 'Wondrous item, very rare You can speak the carpet''s command word as an action to make the carpet hover and fly. It moves according to your spoken directions, provided that you are within 30 feet of it. This carpet is 3 feet by 5 feet and has a flying speed of 80 feet. It can carry up to 400 pounds, but its flying speed becomes 40 feet while carrying over 200 pounds.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Carpet of Flying (4 ft. × 6 ft.)', 'Wondrous item, very rare You can speak the carpet''s command word as an action to make the carpet hover and fly. It moves according to your spoken directions, provided that you are within 30 feet of it. This carpet is 4 feet by 6 feet and has a flying speed of 60 feet. It can carry up to 800 pounds, but its flying speed becomes 30 feet while carrying over 400 pounds.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Carpet of Flying (5 ft. × 7 ft.)', 'Wondrous item, very rare You can speak the carpet''s command word as an action to make the carpet hover and fly. It moves according to your spoken directions, provided that you are within 30 feet of it. This carpet is 5 feet by 7 feet and has a flying speed of 40 feet. It can carry up to 1200 pounds, but its flying speed becomes 20 feet while carrying over 600 pounds.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Carpet of Flying (6 ft. x 9 ft.)', 'Wondrous item, very rare You can speak the carpet''s command word as an action to make the carpet hover and fly. It moves according to your spoken directions, provided that you are within 30 feet of it. This carpet is 6 feet by 9 feet and has a flying speed of 30 feet. It can carry up to 1600 pounds, but its flying speed becomes 15 feet while carrying over 800 pounds.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Censer of Controlling Air Elementals', 'Wondrous item, rare While incense is burning in this censer, you can use an action to speak the censer''s command word and summon an air elemental, as if you had cast the conjure elemental spell. The censer can''t be used this way again until the next dawn. This 6-inch-wide, 1-foot-high vessel resembles a chalice with a decorated lid. It weighs 1 pound.', 1.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Circlet of Blasting', 'Wondrous item, uncommon While wearing this circlet, you can use an action to cast the scorching ray spell with it. When you make the spell''s attacks, you do so with an attack bonus of +5. The circlet can''t be used this way again until the next dawn.', 0.0, 0, 
    True, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Cloak of Protection', 'Wondrous item, uncommon (requires attunement) You gain a +1 bonus to AC and saving throws while you wear this cloak.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{cloak}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Cloak of the Manta Ray', 'Wondrous item, uncommon While wearing this cloak with its hood up, you can breathe underwater, and you have a swimming speed of 60 feet. Pulling the hood up or down requires an action.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{cloak}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Crystal Ball of Telepathy', 'Wondrous item, legendary (requires attunement) The crystal ball is about 6 inches in diameter. While touching it, you can cast the scrying spell (save DC 17) with it. ***Crystal Ball of Telepathy.*** While scrying with the crystal ball, you can communicate telepathically with creatures you can see within 30 feet of the spell''s sensor. You can also use an action to cast the suggestion spell (save DC 17) through the sensor on one of those creatures. You don''t need to concentrate on this suggestion to maintain it during its duration, but it ends if scrying ends. Once used, the suggestion power of the crystal ball can''t be used again until the next dawn.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Crystal Ball of True Seeing', 'Wondrous item, legendary (requires attunement) The crystal ball is about 6 inches in diameter. While touching it, you can cast the scrying spell (save DC 17) with it. ***Crystal Ball of True Seeing.*** While scrying with the crystal ball, you have truesight with a radius of 120 feet centered on the spell''s sensor.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Dagger of Venom', 'Weapon (dagger), rare You gain a +1 bonus to attack and damage rolls made with this magic weapon. You can use an action to cause thick, black poison to coat the blade. The poison remains for 1 minute or until an attack using this weapon hits a creature. That creature must succeed on a DC 15 Constitution saving throw or take 2d10 poison damage and become poisoned for 1 minute. The dagger can''t be used this way again until the next dawn.', 0.0, 0, 
    True, NULL, NULL, True, 
    False, '{mainhand}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Black Dragon Scale Mail', 'Armor (scale mail), very rare (requires attunement) Dragon scale mail is made of the scales of a black dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued. While wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to acid damage. Additionally, you can focus your senses as an action to magically discern the distance and direction to the closest black dragon within 30 miles of you. This special action can''t be used again until the next dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{armor}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Blue Dragon Scale Mail', 'Armor (scale mail), very rare (requires attunement) Dragon scale mail is made of the scales of a blue dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued. While wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to lightning damage. Additionally, you can focus your senses as an action to magically discern the distance and direction to the closest blue dragon within 30 miles of you. This special action can''t be used again until the next dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{armor}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Gold Dragon Scale Mail', 'Armor (scale mail), very rare (requires attunement) Dragon scale mail is made of the scales of a gold dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued. While wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to fire damage. Additionally, you can focus your senses as an action to magically discern the distance and direction to the closest gold dragon within 30 miles of you. This special action can''t be used again until the next dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{armor}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Green Dragon Scale Mail', 'Armor (scale mail), very rare (requires attunement) Dragon scale mail is made of the scales of a green dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued. While wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to poison damage. Additionally, you can focus your senses as an action to magically discern the distance and direction to the closest green dragon within 30 miles of you. This special action can''t be used again until the next dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{armor}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Red Dragon Scale Mail', 'Armor (scale mail), very rare (requires attunement) Dragon scale mail is made of the scales of a red dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued. While wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to fire damage. Additionally, you can focus your senses as an action to magically discern the distance and direction to the closest red dragon within 30 miles of you. This special action can''t be used again until the next dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{armor}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Silver Dragon Scale Mail', 'Armor (scale mail), very rare (requires attunement) Dragon scale mail is made of the scales of a silver dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued. While wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to cold damage. Additionally, you can focus your senses as an action to magically discern the distance and direction to the closest silver dragon within 30 miles of you. This special action can''t be used again until the next dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{armor}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'White Dragon Scale Mail', 'Armor (scale mail), very rare (requires attunement) Dragon scale mail is made of the scales of a white dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued. While wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to cold damage. Additionally, you can focus your senses as an action to magically discern the distance and direction to the closest white dragon within 30 miles of you. This special action can''t be used again until the next dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{armor}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Dust of Disappearance', 'Wondrous item, uncommon Found in a small packet, this powder resembles very fine sand. There is enough of it for one use. When you use an action to throw the dust into the air, you and each creature and object within 10 feet of you become invisible for 2d4 minutes. The duration is the same for all subjects, and the dust is consumed when its magic takes effect. If a creature affected by the dust attacks or casts a spell, the invisibility ends for that creature.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Dwarven Plate', 'Armor (plate), very rare While wearing this armor, you gain a +2 bonus to AC. In addition, if an effect moves you against your will along the ground, you can use your reaction to reduce the distance you are moved by up to 10 feet.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Air Elemental Gem', 'Wondrous item, uncommon This blue sapphire contains a mote of elemental energy. When you use an action to break the gem, an air elemental is summoned as if you had cast the conjure elemental spell, and the gem''s magic is lost.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Earth Elemental Gem', 'Wondrous item, uncommon This yellow diamond contains a mote of elemental energy. When you use an action to break the gem, an earth elemental is summoned as if you had cast the conjure elemental spell, and the gem''s magic is lost.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Fire Elemental Gem', 'Wondrous item, uncommon This red corundum contains a mote of elemental energy. When you use an action to break the gem, a fire elemental is summoned as if you had cast the conjure elemental spell, and the gem''s magic is lost.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Water Elemental Gem', 'Wondrous item, uncommon This emerald contains a mote of elemental energy. When you use an action to break the gem, a water elemental is summoned as if you had cast the conjure elemental spell, and the gem''s magic is lost.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Elven Chain', 'Armor (chain shirt), rare You gain a +1 bonus to AC while you wear this armor. You are considered proficient with this armor even if you lack proficiency with medium armor.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, '{armor}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Anchor Feather Token', 'Wondrous item, rare This tiny object looks like a feather. You can use an action to touch the token to a boat or ship. For the next 24 hours, the vessel can''t be moved by any means. Touching the token to the vessel again ends the effect. When the effect ends, the token disappears.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Bird Feather Token', 'Wondrous item, rare This tiny object looks like a feather. You can use an action to toss the token 5 feet into the air. The token disappears and an enormous, multicolored bird takes its place. The bird has the statistics of a roc, but it obeys your simple commands and can''t attack. It can carry up to 500 pounds while flying at its maximum speed (16 miles an hour for a maximum of 144 miles per day, with a one-hour rest for every 3 hours of flying), or 1,000 pounds at half that speed. The bird disappears after flying its maximum distance for a day or if it drops to 0 hit points. You can dismiss the bird as an action.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Fan Feather Token', 'Wondrous item, rare This tiny object looks like a feather. If you are on a boat or ship, you can use an action to toss the token up to 10 feet in the air. The token disappears, and a giant flapping fan takes its place. The fan floats and creates a wind strong enough to fill the sails of one ship, increasing its speed by 5 miles per hour for 8 hours. You can dismiss the fan as an action.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Swan Boat Feather Token', 'Wondrous item, rare This tiny object looks like a feather. You can use an action to touch the token to a body of water at least 60 feet in diameter. The token disappears, and a 50-foot-long, 20-foot wide boat shaped like a swan takes its place. The boat is self-propelled and moves across water at a speed of 6 miles per hour. You can use an action while on the boat to command it to move or to turn up to 90 degrees. The boat can carry up to thirty-two Medium or smaller creatures. A Large creature counts as four Medium creatures, while a Huge creature counts as nine. The boat remains for 24 hours and then disappears. You can dismiss the boat as an action.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Tree Feather Token', 'Wondrous item, rare This tiny object looks like a feather. You must be outdoors to use this token. You can use an action to touch it to an unoccupied space on the ground. The token disappears, and in its place a nonmagical oak tree springs into existence. The tree is 60 feet tall and has a 5-foot-diameter trunk, and its branches at the top spread out in a 20-foot radius.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Whip Feather Token', 'Wondrous item, rare This tiny object looks like a feather. You can use an action to throw the token to a point within 10 feet of you. The token disappears, and a floating whip takes its place. You can then use a bonus action to make a melee spell attack against a creature within 10 feet of the whip, with an attack bonus of +9. On a hit, the target takes 1d6 + 5 force damage. As a bonus action on your turn, you can direct the whip to fly up to 20 feet and repeat the attack against a creature within 10 feet of it. The whip disappears after 1 hour, when you use an action to dismiss it, or when you are incapacitated or die.', 0.0, 0, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ebony Fly Figurine of Wondrous Power', 'Wondrous item, rare A figurine of wondrous power is a statuette of a beast small enough to fit in a pocket. If you use an action to speak the command word and throw the figurine to a point on the ground within 60 feet of you, the figurine becomes a living creature. If the space where the creature would appear is occupied by other creatures or objects, or if there isn''t enough space for the creature, the figurine doesn''t become a creature. The creature is friendly to you and your companions. It understands your languages and obeys your spoken commands. If you issue no commands, the creature defends itself but takes no other actions. The creature exists for a duration specific to each figurine. At the end of the duration, the creature reverts to its figurine form. It reverts to a figurine early if it drops to 0 hit points or if you use an action to speak the command word again while touching it. When the creature becomes a figurine again, its property can''t be used again until a certain amount of time has passed, as specified in the figurine''s description. ***Ebony Fly.*** This ebony statuette is carved in the likeness of a horsefly. It can become a giant fly for up to 12 hours and can be ridden as a mount. Once it has been used, it can''t be used again until 2 days have passed. Giant Fly Large beast, unaligned Armor Class 11 Hit Points 19 (3d10 + 3) Speed 30 ft., fly 60 ft. | STR | DEX | CON | INT | WIS | CHA | |---|---|---|---|---|---| | 14 (+2) | 13 (+1) | 13 (+1) | 2 (-4) | 10 (+0) | 3 (-4) | Senses darkvision 60 ft., passive Perception 10 Languages -', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Golden Lions Figurine of Wondrous Power', 'Wondrous item, rare A figurine of wondrous power is a statuette of a beast small enough to fit in a pocket. If you use an action to speak the command word and throw the figurine to a point on the ground within 60 feet of you, the figurine becomes a living creature. If the space where the creature would appear is occupied by other creatures or objects, or if there isn''t enough space for the creature, the figurine doesn''t become a creature. The creature is friendly to you and your companions. It understands your languages and obeys your spoken commands. If you issue no commands, the creature defends itself but takes no other actions. The creature exists for a duration specific to each figurine. At the end of the duration, the creature reverts to its figurine form. It reverts to a figurine early if it drops to 0 hit points or if you use an action to speak the command word again while touching it. When the creature becomes a figurine again, its property can''t be used again until a certain amount of time has passed, as specified in the figurine''s description. ***Golden Lions.*** These gold statuettes of lions are always created in pairs. You can use one figurine or both simultaneously. Each can become a lion for up to 1 hour. Once a lion has been used, it can''t be used again until 7 days have passed.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Marble Elephant Figurine of Wondrous Power', 'Wondrous item, rare A figurine of wondrous power is a statuette of a beast small enough to fit in a pocket. If you use an action to speak the command word and throw the figurine to a point on the ground within 60 feet of you, the figurine becomes a living creature. If the space where the creature would appear is occupied by other creatures or objects, or if there isn''t enough space for the creature, the figurine doesn''t become a creature. The creature is friendly to you and your companions. It understands your languages and obeys your spoken commands. If you issue no commands, the creature defends itself but takes no other actions. The creature exists for a duration specific to each figurine. At the end of the duration, the creature reverts to its figurine form. It reverts to a figurine early if it drops to 0 hit points or if you use an action to speak the command word again while touching it. When the creature becomes a figurine again, its property can''t be used again until a certain amount of time has passed, as specified in the figurine''s description. ***Marble Elephant.*** This marble statuette is about 4 inches high and long. It can become an elephant for up to 24 hours. Once it has been used, it can''t be used again until 7 days have passed.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Onyx Dog Figurine of Wondrous Power', 'Wondrous item, rare A figurine of wondrous power is a statuette of a beast small enough to fit in a pocket. If you use an action to speak the command word and throw the figurine to a point on the ground within 60 feet of you, the figurine becomes a living creature. If the space where the creature would appear is occupied by other creatures or objects, or if there isn''t enough space for the creature, the figurine doesn''t become a creature. The creature is friendly to you and your companions. It understands your languages and obeys your spoken commands. If you issue no commands, the creature defends itself but takes no other actions. The creature exists for a duration specific to each figurine. At the end of the duration, the creature reverts to its figurine form. It reverts to a figurine early if it drops to 0 hit points or if you use an action to speak the command word again while touching it. When the creature becomes a figurine again, its property can''t be used again until a certain amount of time has passed, as specified in the figurine''s description. ***Onyx Dog.*** This onyx statuette of a dog can become a mastiff for up to 6 hours. The mastiff has an Intelligence of 8 and can speak Common. It also has darkvision out to a range of 60 feet and can see invisible creatures and objects within that range. Once it has been used, it can''t be used again until 7 days have passed.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    True, NULL, NULL, True, 
    True, '{mainhand,offhand,twohand}', NULL,
    NULL, NULL, 'rare',
    False, NULL
);
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Gauntlets of Ogre Power', 'Wondrous item, uncommon (requires attunement) Your Strength score is 19 while you wear these gauntlets. They have no effect on you if your Strength is already 19 or higher.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Giant Slayer', 'Weapon (any axe or sword), rare You gain a +1 bonus to attack and damage rolls made with this magic weapon. When you hit a giant with it, the giant takes an extra 2d6 damage of the weapon''s type and must succeed on a DC 15 Strength saving throw or fall prone. For the purpose of this weapon, "giant" refers to any creature with the giant type, including ettins and trolls.', 0.0, 0, 
    True, NULL, NULL, True, 
    False, '{mainhand,offhand,twohand}', NULL,
    NULL, NULL, 'rare',
    False, NULL
);
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Gloves of Missile Snaring', 'Wondrous item, uncommon (requires attunement) These gloves seem to almost meld into your hands when you don them. When a ranged weapon attack hits you while you''re wearing them, you can use your reaction to reduce the damage by 1d10 + your Dexterity modifier, provided that you have a free hand. If you reduce the damage to 0, you can catch the missile if it is small enough for you to hold in that hand.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Gloves of Swimming and Climbing', 'Wondrous item, uncommon (requires attunement) While wearing these gloves, climbing and swimming don''t cost you extra movement, and you gain a +5 bonus to Strength (Athletics) checks made to climb or swim.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Goggles of Night', 'Wondrous item, uncommon While wearing these dark lenses, you have darkvision out to a range of 60 feet. If you already have darkvision, wearing the goggles increases its range by 60 feet.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Hat of Disguise', 'Wondrous item, uncommon (requires attunement) While wearing this hat, you can use an action to cast the disguise self spell from it at will. The spell ends if the hat is removed.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{head}', NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Headband of Intellect', 'Wondrous item, uncommon (requires attunement) Your Intelligence score is 19 while you wear this headband. It has no effect on you if your Intelligence is already 19 or higher.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Helm of Comprehending Languages', 'Wondrous item, uncommon While wearing this helm, you can use an action to cast the comprehend languages spell from it at will.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Helm of Telepathy', 'Wondrous item, uncommon (requires attunement) While wearing this helm, you can use an action to cast the detect thoughts spell (save DC 13) from it. As long as you maintain concentration on the spell, you can use a bonus action to send a telepathic message to a creature you are focused on. It can reply-using a bonus action to do so-while your focus on it continues. While focusing on a creature with detect thoughts, you can use an action to cast the suggestion spell (save DC 13) from the helm on that creature. Once used, the suggestion property can''t be used again until the next dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Helm of Teleportation', 'Wondrous item, rare (requires attunement) This helm has 3 charges. While wearing it, you can use an action and expend 1 charge to cast the teleport spell from it. The helm regains 1d3 expended charges daily at dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Holy Avenger', 'Weapon (any sword), legendary (requires attunement by a paladin) You gain a +3 bonus to attack and damage rolls made with this magic weapon. When you hit a fiend or an undead with it, that creature takes an extra 2d10 radiant damage. While you hold the drawn sword, it creates an aura in a 10-foot radius around you. You and all creatures friendly to you in the aura have advantage on saving throws against spells and other magical effects. If you have 17 or more levels in the paladin class, the radius of the aura increases to 30 feet.', 0.0, 0, 
    True, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Brass Horn of Valhalla', 'Wondrous item, rare You can use an action to blow this horn. In response, 3d4 + 3 warrior spirits from the Valhalla appear within 60 feet of you. They use the statistics of a berserker. They return to Valhalla after 1 hour or when they drop to 0 hit points. Once you use the horn, it can''t be used again until 7 days have passed. If you blow the horn without having proficiency with all simple weapons, the summoned berserkers attack you. If you meet the requirement, they are friendly to you and your companions and follow your commands.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Bronze Horn of Valhalla', 'Wondrous item, very rare You can use an action to blow this horn. In response, 4d4 + 4 warrior spirits from the Valhalla appear within 60 feet of you. They use the statistics of a berserker. They return to Valhalla after 1 hour or when they drop to 0 hit points. Once you use the horn, it can''t be used again until 7 days have passed. If you blow the horn without having proficiency with all medium armor, the summoned berserkers attack you. If you meet the requirement, they are friendly to you and your companions and follow your commands.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Iron Horn of Valhalla', 'Wondrous item, legendary You can use an action to blow this horn. In response, 5d4 + 5 warrior spirits from the Valhalla appear within 60 feet of you. They use the statistics of a berserker. They return to Valhalla after 1 hour or when they drop to 0 hit points. Once you use the horn, it can''t be used again until 7 days have passed. If you blow the horn without having proficiency with all martial weapons, the summoned berserkers attack you. If you meet the requirement, they are friendly to you and your companions and follow your commands.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Silver Horn of Valhalla', 'Wondrous item, rare You can use an action to blow this horn. In response, 2d4 + 2 warrior spirits from the Valhalla appear within 60 feet of you. They use the statistics of a berserker. They return to Valhalla after 1 hour or when they drop to 0 hit points. Once you use the horn, it can''t be used again until 7 days have passed. The summoned berserkers are friendly to you and your companions and follow your commands.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Horseshoes of Speed', 'Wondrous item, rare These iron horseshoes come in a set of four. While all four shoes are affixed to the hooves of a horse or similar creature, they increase the creature''s walking speed by 30 feet.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Absorption', 'Wondrous item, very rare (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Absorption.*** While this pale lavender ellipsoid orbits your head, you can use your reaction to cancel a spell of 4th level or lower cast by a creature you can see and targeting only you. Once the stone has canceled 20 levels of spells, it burns out and turns dull gray, losing its magic. If you are targeted by a spell whose level is higher than the number of spell levels the stone has left, the stone can''t cancel it.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Agility', 'Wondrous item, very rare (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Agility.*** Your Dexterity score increases by 2, to a maximum of 20, while this deep red sphere orbits your head.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Fortitude', 'Wondrous item, very rare (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Fortitude.*** Your Constitution score increases by 2, to a maximum of 20, while this pink rhomboid orbits your head.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Greater Absorption', 'Wondrous item, legendary (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Greater Absorption.*** While this marbled lavender and green ellipsoid orbits your head, you can use your reaction to cancel a spell of 8th level or lower cast by a creature you can see and targeting only you. Once the stone has canceled 50 levels of spells, it burns out and turns dull gray, losing its magic. If you are targeted by a spell whose level is higher than the number of spell levels the stone has left, the stone can''t cancel it.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Insight', 'Wondrous item, very rare (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Insight.*** Your Wisdom score increases by 2, to a maximum of 20, while this incandescent blue sphere orbits your head.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Intellect', 'Wondrous item, very rare (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Intellect.*** Your Intelligence score increases by 2, to a maximum of 20, while this marbled scarlet and blue sphere orbits your head.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Leadership', 'Wondrous item, very rare (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Leadership.*** Your Charisma score increases by 2, to a maximum of 20, while this marbled pink and green sphere orbits your head.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Mastery', 'Wondrous item, legendary (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Mastery.*** Your proficiency bonus increases by 1 while this pale green prism orbits your head.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Protection', 'Wondrous item, rare (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Protection.*** You gain a +1 bonus to AC while this dusty rose prism orbits your head.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Regeneration', 'Wondrous item, legendary (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Regeneration.*** You regain 15 hit points at the end of each hour this pearly white spindle orbits your head, provided that you have at least 1 hit point.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Reserve', 'Wondrous item, rare (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Reserve.*** This vibrant purple prism stores spells cast into it, holding them until you use them. The stone can store up to 3 levels worth of spells at a time. When found, it contains 1d4 - 1 levels of stored spells chosen by the GM. Any creature can cast a spell of 1st through 3rd level into the stone by touching it as the spell is cast. The spell has no effect, other than to be stored in the stone. If the stone can''t hold the spell, the spell is expended without effect. The level of the slot used to cast the spell determines how much space it uses. While this stone orbits your head, you can cast any spell stored in it. The spell uses the slot level, spell save DC, spell attack bonus, and spellcasting ability of the original caster, but is otherwise treated as if you cast the spell. The spell cast from the stone is no longer stored in it, freeing up space.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Strength', 'Wondrous item, very rare (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Strength.*** Your Strength score increases by 2, to a maximum of 20, while this pale blue rhomboid orbits your head.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ioun Stone of Sustenance', 'Wondrous item, rare (requires attunement) An Ioun stone is named after Ioun, a god of knowledge and prophecy revered on some worlds. Many types of Ioun stone exist, each type a distinct combination of shape and color. When you use an action to toss one of these stones into the air, the stone orbits your head at a distance of 1d3 feet and confers a benefit to you. Thereafter, another creature must use an action to grasp or net the stone to separate it from you, either by making a successful attack roll against AC 24 or a successful DC 24 Dexterity (Acrobatics) check. You can use an action to seize and stow the stone, ending its effect. A stone has AC 24, 10 hit points, and resistance to all damage. It is considered to be an object that is being worn while it orbits your head. ***Sustenance.*** You don''t need to eat or drink while this clear spindle orbits your head.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Mace of Disruption', 'Weapon (mace), rare (requires attunement) When you hit a fiend or an undead with this magic weapon, that creature takes an extra 2d6 radiant damage. If the target has 25 hit points or fewer after taking this damage, it must succeed on a DC 15 Wisdom saving throw or be destroyed. On a successful save, the creature becomes frightened of you until the end of your next turn. While you hold this weapon, it sheds bright light in a 20-foot radius and dim light for an additional 20 feet.', 0.0, 0, 
    True, NULL, NULL, True, 
    True, '{mainhand}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Mantle of Spell Resistance', 'Wondrous item, rare (requires attunement) You have advantage on saving throws against spells while you wear this cloak.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{cloak}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Manual of Golems', 'Wondrous item, very rare This tome contains information and incantations necessary to make a particular type of golem. The GM chooses the type or determines it randomly. To decipher and use the manual, you must be a spellcaster with at least two 5th-level spell slots. A creature that can''t use a manual of golems and attempts to read it takes 6d6 psychic damage. | d20 | Golem | Time | Cost | |---|---|---|---| | 1-5 | Clay | 30 days | 65,000 gp | | 6-17 | Flesh | 60 days | 50,000 gp | | 18 | Iron | 120 days | 100,000 gp | | 19-20 | Stone | 90 days | 80,000 gp | To create a golem, you must spend the time shown on the table, working without interruption with the manual at hand and resting no more than 8 hours per day. You must also pay the specified cost to purchase supplies. Once you finish creating the golem, the book is consumed in eldritch flames. The golem becomes animate when the ashes of the manual are sprinkled on it. It is under your control, and it understands and obeys your spoken commands.', 0.0, 295000, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Manual of Clay Golems', 'Wondrous item, very rare This tome contains information and incantations necessary to make a clay golem. To decipher and use the manual, you must be a spellcaster with at least two 5th-level spell slots. A creature that can''t use a manual of golems and attempts to read it takes 6d6 psychic damage. To create a golem, you must spend 30 days, working without interruption with the manual at hand and resting no more than 8 hours per day. You must also pay 65,000 gp to purchase supplies. Once you finish creating the golem, the book is consumed in eldritch flames. The golem becomes animate when the ashes of the manual are sprinkled on it. It is under your control, and it understands and obeys your spoken commands.', 0.0, 65000, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Manual of Flesh Golems', 'Wondrous item, very rare This tome contains information and incantations necessary to make a flesh golem. To decipher and use the manual, you must be a spellcaster with at least two 5th-level spell slots. A creature that can''t use a manual of golems and attempts to read it takes 6d6 psychic damage. To create a golem, you must spend 60 days, working without interruption with the manual at hand and resting no more than 8 hours per day. You must also pay 50,000 gp to purchase supplies. Once you finish creating the golem, the book is consumed in eldritch flames. The golem becomes animate when the ashes of the manual are sprinkled on it. It is under your control, and it understands and obeys your spoken commands.', 0.0, 50000, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Manual of Iron Golems', 'Wondrous item, very rare This tome contains information and incantations necessary to make an iron golem. To decipher and use the manual, you must be a spellcaster with at least two 5th-level spell slots. A creature that can''t use a manual of golems and attempts to read it takes 6d6 psychic damage. To create a golem, you must spend 120 days, working without interruption with the manual at hand and resting no more than 8 hours per day. You must also pay 100,000 gp to purchase supplies. Once you finish creating the golem, the book is consumed in eldritch flames. The golem becomes animate when the ashes of the manual are sprinkled on it. It is under your control, and it understands and obeys your spoken commands.', 0.0, 100000, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Manual of Stone Golems', 'Wondrous item, very rare This tome contains information and incantations necessary to make a stone golem. To decipher and use the manual, you must be a spellcaster with at least two 5th-level spell slots. A creature that can''t use a manual of golems and attempts to read it takes 6d6 psychic damage. To create a golem, you must spend 90 days, working without interruption with the manual at hand and resting no more than 8 hours per day. You must also pay 80,000 gp to purchase supplies. Once you finish creating the golem, the book is consumed in eldritch flames. The golem becomes animate when the ashes of the manual are sprinkled on it. It is under your control, and it understands and obeys your spoken commands.', 0.0, 80000, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Medallion of Thoughts', 'Wondrous item, uncommon (requires attunement) The medallion has 3 charges. While wearing it, you can use an action and expend 1 charge to cast the detect thoughts spell (save DC 13) from it. The medallion regains 1d3 expended charges daily at dawn.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Necklace of Adaptation', 'Wondrous item, uncommon (requires attunement) While wearing this necklace, you can breathe normally in any environment, and you have advantage on saving throws made against harmful gases and vapors (such as cloudkill and stinking cloud effects, inhaled poisons, and the breath weapons of some dragons).', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Oil of Sharpness', 'Potion, very rare This clear, gelatinous oil sparkles with tiny, ultrathin silver shards. The oil can coat one slashing or piercing weapon or up to 5 pieces of slashing or piercing ammunition. Applying the oil takes 1 minute. For 1 hour, the coated item is magical and has a +3 bonus to attack and damage rolls.', 0.0, 0, 
    True, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Pearl of Power', 'Wondrous item, uncommon (requires attunement by a spellcaster) While this pearl is on your person, you can use an action to speak its command word and regain one expended spell slot. If the expended slot was of 4th level or higher, the new slot is 3rd level. Once you use the pearl, it can''t be used again until the next dawn.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Periapt of Health', 'Wondrous item, uncommon You are immune to contracting any disease while you wear this pendant. If you are already infected with a disease, the effects of the disease are suppressed you while you wear the pendant.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Periapt of Proof against Poison', 'Wondrous item, rare This delicate silver chain has a brilliant-cut black gem pendant. While you wear it, poisons have no effect on you. You are immune to the poisoned condition and have immunity to poison damage.', 0.0, 0, 
    False, NULL, NULL, True, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Periapt of Wound Closure', 'Wondrous item, uncommon (requires attunement) While you wear this pendant, you stabilize whenever you are dying at the start of your turn. In addition, whenever you roll a Hit Die to regain hit points, double the number of hit points it restores.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Plate Armor of Etherealness', 'Armor (plate), legendary (requires attunement) While you''re wearing this armor, you can speak its command word as an action to gain the effect of the etherealness spell, which last for 10 minutes or until you remove the armor or use an action to speak the command word again. This property of the armor can''t be used again until the next dawn.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{armor}', NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Portable Hole', 'Wondrous item, rare This fine black cloth, soft as silk, is folded up to the dimensions of a handkerchief. It unfolds into a circular sheet 6 feet in diameter. You can use an action to unfold a portable hole and place it on or against a solid surface, whereupon the portable hole creates an extradimensional hole 10 feet deep. The cylindrical space within the hole exists on a different plane, so it can''t be used to create open passages. Any creature inside an open portable hole can exit the hole by climbing out of it. You can use an action to close a portable hole by taking hold of the edges of the cloth and folding it up. Folding the cloth closes the hole, and any creatures or objects within remain in the extradimensional space. No matter what''s in it, the hole weighs next to nothing. If the hole is folded up, a creature within the hole''s extradimensional space can use an action to make a DC 10 Strength check. On a successful check, the creature forces its way out and appears within 5 feet of the portable hole or the creature carrying it. A breathing creature within a closed portable hole can survive for up to 10 minutes, after which time it begins to suffocate. Placing a portable hole inside an extradimensional space created by a bag of holding, handy haversack, or similar item instantly destroys both items and opens a gate to the Astral Plane. The gate originates where the one item was placed inside the other. Any creature within 10 feet of the gate is sucked through it and deposited in a random location on the Astral Plane. The gate then closes. The gate is one-way only and can''t be reopened.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Animal Friendship', 'Potion, uncommon When you drink this potion, you can cast the animal friendship spell (save DC 13) for 1 hour at will. Agitating this muddy liquid brings little bits into view: a fish scale, a hummingbird tongue, a cat claw, or a squirrel hair.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Clairvoyance', 'Potion, rare When you drink this potion, you gain the effect of the clairvoyance spell. An eyeball bobs in this yellowish liquid but vanishes when the potion is opened.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Flying', 'Potion, very rare When you drink this potion, you gain a flying speed equal to your walking speed for 1 hour and can hover. If you''re in the air when the potion wears off, you fall unless you have some other means of staying aloft. This potion''s clear liquid floats at the top of its container and has cloudy white impurities drifting in it.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Gaseous Form', 'Potion, rare When you drink this potion, you gain the effect of the gaseous form spell for 1 hour (no concentration required) or until you end the effect as a bonus action. This potion''s container seems to hold fog that moves and pours like water.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Cloud Giant Strength', 'Potion, very rare When you drink this potion, your Strength score changes to 27 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score. This potion''s transparent liquid has floating in it a sliver of fingernail from a cloud giant.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Fire Giant Strength', 'Potion, rare When you drink this potion, your Strength score changes to 25 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score. This potion''s transparent liquid has floating in it a sliver of fingernail from a fire giant.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Frost Giant Strength', 'Potion, rare When you drink this potion, your Strength score changes to 23 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score. This potion''s transparent liquid has floating in it a sliver of fingernail from a frost giant.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Hill Giant Strength', 'Potion, uncommon When you drink this potion, your Strength score changes to 21 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score. This potion''s transparent liquid has floating in it a sliver of fingernail from a hill giant.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Stone Giant Strength', 'Potion, rare When you drink this potion, your Strength score changes to 23 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score. This potion''s transparent liquid has floating in it a sliver of fingernail from a stone giant.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Storm Giant Strength', 'Potion, legendary When you drink this potion, your Strength score changes to 29 for 1 hour. The potion has no effect on you if your Strength is equal to or greater than that score. This potion''s transparent liquid has floating in it a sliver of fingernail from a storm giant.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Greater Healing', 'Potion, uncommon You regain 4d4 + 4 hit points when you drink this potion. The potion''s red liquid glimmers when agitated.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Superior Healing', 'Potion, rare You regain 8d4 + 8 hit points when you drink this potion. The potion''s red liquid glimmers when agitated.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Supreme Healing', 'Potion, very rare You regain 10d4 + 20 hit points when you drink this potion. The potion''s red liquid glimmers when agitated.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Heroism', 'Potion, rare For 1 hour after drinking it, you gain 10 temporary hit points that last for 1 hour. For the same duration, you are under the effect of the bless spell (no concentration required). This blue potion bubbles and steams as if boiling.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Invisibility', 'Potion, very rare This potion''s container looks empty but feels as though it holds liquid. When you drink it, you become invisible for 1 hour. Anything you wear or carry is invisible with you. The effect ends early if you attack or cast a spell.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Mind Reading', 'Potion, rare When you drink this potion, you gain the effect of the detect thoughts spell (save DC 13). The potion''s dense, purple liquid has an ovoid cloud of pink floating in it.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Acid Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to acid damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Cold Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to cold damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Fire Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to fire damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Force Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to force damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Lightning Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to lightning damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Necrotic Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to necrotic damage for 1 hour.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Poison Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to poison damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Psychic Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to psychic damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Radiant Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to radiant damage for 1 hour.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Thunder Resistance', 'Potion, uncommon When you drink this potion, you gain resistance to thunder damage for 1 hour.', 0.0, 50, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Speed', 'Potion, very rare When you drink this potion, you gain the effect of the haste spell for 1 minute (no concentration required). The potion''s yellow fluid is streaked with black and swirls on its own.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'very_rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Potion of Water Breathing', 'Potion, uncommon You can breathe underwater for 1 hour after drinking this potion. Its cloudy green fluid smells of the sea and has a jellyfish-like bubble floating in it.', 0.0, 0, 
    False, NULL, NULL, False, 
    False, NULL, NULL,
    NULL, NULL, 'common',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Evasion', 'Ring, rare (requires attunement) This ring has 3 charges, and it regains 1d3 expended charges daily at dawn. When you fail a Dexterity saving throw while wearing it, you can use your reaction to expend 1 of its charges to succeed on that saving throw instead.', 0.0, 0, 
    False, NULL, NULL, False, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Feather Falling', 'Ring, rare (requires attunement) When you fall while wearing this ring, you descend 60 feet per round and take no damage from falling.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Free Action', 'Ring, rare (requires attunement) While you wear this ring, difficult terrain doesn''t cost you extra movement. In addition, magic can neither reduce your speed nor cause you to be paralyzed or restrained.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Invisibility', 'Ring, legendary (requires attunement) While wearing this ring, you can turn invisible as an action. Anything you are wearing or carrying is invisible with you. You remain invisible until the ring is removed, until you attack or cast a spell, or until you use a bonus action to become visible again.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'legendary',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Jumping', 'Ring, uncommon (requires attunement) While wearing this ring, you can cast the jump spell from it as a bonus action at will, but can target only yourself when you do so.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, NULL, NULL,
    NULL, NULL, 'uncommon',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Protection', 'Ring, rare (requires attunement) You gain a +1 bonus to AC and saving throws while wearing this ring.', 0.0, 0, 
    False, NULL, NULL, True, 
    True, '{ring}', NULL,
    NULL, NULL, 'rare',
    False, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Acid Resistance', 'Ring, rare (requires attunement) You have resistance to acid damage while wearing this pearl ring.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, '{ring}', NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Cold Resistance', 'Ring, rare (requires attunement) You have resistance to cold damage while wearing this tourmaline ring.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, NULL, NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Fire Resistance', 'Ring, rare (requires attunement) You have resistance to fire damage while wearing this garnet ring.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, '{ring}', NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Force Resistance', 'Ring, rare (requires attunement) You have resistance to force damage while wearing this sapphire ring.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, '{ring}', NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Lightning Resistance', 'Ring, rare (requires attunement) You have resistance to lightning damage while wearing this citrine ring.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, '{ring}', NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Necrotic Resistance', 'Ring, rare (requires attunement) You have resistance to necrotic damage while wearing this jet ring.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, '{ring}', NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Poison Resistance', 'Ring, rare (requires attunement) You have resistance to poison damage while wearing this amethyst ring.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, '{ring}', NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Psychic Resistance', 'Ring, rare (requires attunement) You have resistance to psychic damage while wearing this jade ring.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, '{ring}', NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Radiant Resistance', 'Ring, rare (requires attunement) You have resistance to radiant damage while wearing this topaz ring.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, '{ring}', NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Thunder Resistance', 'Ring, rare (requires attunement) You have resistance to thunder damage while wearing this spinel ring.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, '{ring}', NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Swimming', 'Ring, uncommon You have a swimming speed of 40 feet while wearing this ring.', 0.0, 0, 
    false, NULL, NULL, true, 
    false, '{ring}', NULL,
    NULL, NULL, 'common',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Telekinesis', 'Ring, very rare (requires attunement) While wearing this ring, you can cast the telekinesis spell at will, but you can target only objects that aren''t being worn or carried.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, NULL, NULL,
    NULL, NULL, 'very_rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Three Wishes', 'Ring, legendary While wearing this ring, you can use an action to expend 1 of its 3 charges to cast the wish spell from it. The ring becomes nonmagical when you use the last charge.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, NULL, NULL,
    NULL, NULL, 'legendary',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Warmth', 'Ring, uncommon (requires attunement) While wearing this ring, you have resistance to cold damage. In addition, you and everything you wear and carry are unharmed by temperatures as low as -50 degrees Fahrenheit.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, NULL, NULL,
    NULL, NULL, 'uncommon',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of Water Walking', 'Ring, uncommon While wearing this ring, you can stand on and move across any liquid surface as if it were solid ground.', 0.0, 0, 
    false, NULL, NULL, true, 
    false, NULL, NULL,
    NULL, NULL, 'uncommon',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Ring of X-ray Vision', 'Ring, rare (requires attunement) While wearing this ring, you can use an action to speak its command word. When you do so, you can see into and through solid matter for 1 minute. This vision has a radius of 30 feet. To you, solid objects within that radius appear transparent and don''t prevent light from passing through them. The vision can penetrate 1 foot of stone, 1 inch of common metal, or up to 3 feet of wood or dirt. Thicker substances block the vision, as does a thin sheet of lead. Whenever you use the ring again before taking a long rest, you must succeed on a DC 15 Constitution saving throw or gain one level of exhaustion.', 0.0, 0, 
    false, NULL, NULL, false, 
    true, NULL, NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Robe of Scintillating Colors', 'Wondrous item, very rare (requires attunement) This robe has 3 charges, and it regains 1d3 expended charges daily at dawn. While you wear it, you can use an action and expend 1 charge to cause the garment to display a shifting pattern of dazzling hues until the end of your next turn. During this time, the robe sheds bright light in a 30-foot radius and dim light for an additional 30 feet. Creatures that can see you have disadvantage on attack rolls against you. In addition, any creature in the bright light that can see you when the robe''s power is activated must succeed on a DC 15 Wisdom saving throw or become stunned until the effect ends.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, NULL, NULL,
    NULL, NULL, 'very_rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Robe of the Archmagi', 'Wondrous item, legendary (requires attunement by a sorcerer, warlock, or wizard) This elegant garment is made from exquisite cloth of white, gray, or black and adorned with silvery runes. The robe''s color corresponds to the alignment for which the item was created. A white robe was made for good, gray for neutral, and black for evil. You can''t attune to a robe of the archmagi that doesn''t correspond to your alignment. You gain these benefits while wearing the robe: If you aren''t wearing armor, your base Armor Class is 15 + your Dexterity modifier. You have advantage on saving throws against spells and other magical effects. Your spell save DC and spell attack bonus each increase by 2.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, NULL, NULL,
    NULL, NULL, 'legendary',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Rod of Security', 'Rod, very rare While holding this rod, you can use an action to activate it. The rod then instantly transports you and up to 199 other willing creatures you can see to a paradise that exists in an extraplanar space. You choose the form that the paradise takes. It could be a tranquil garden, lovely glade, cheery tavern, immense palace, tropical island, fantastic carnival, or whatever else you can imagine. Regardless of its nature, the paradise contains enough water and food to sustain its visitors. Everything else that can be interacted with inside the extraplanar space can exist only there. For example, a flower picked from a garden in the paradise disappears if it is taken outside the extraplanar space. For each hour spent in the paradise, a visitor regains hit points as if it had spent 1 Hit Die. Also, creatures don''t age while in the paradise, although time passes normally. Visitors can remain in the paradise for up to 200 days divided by the number of creatures present (round down). When the time runs out or you use an action to end it, all visitors reappear in the location they occupied when you activated the rod, or an unoccupied space nearest that location. The rod can''t be used again until ten days have passed.', 0.0, 0, 
    false, NULL, NULL, false, 
    false, NULL, NULL,
    NULL, NULL, 'very_rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Scimitar of Speed', 'Weapon (scimitar), very rare (requires attunement) You gain a +2 bonus to attack and damage rolls made with this magic weapon. In addition, you can make one attack with it as a bonus action on each of your turns.', 0.0, 0, 
    true, NULL, NULL, true, 
    true, '{mainhand}', NULL,
    NULL, NULL, 'very_rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Spell Scroll (Cantrip)', 'Scroll, common A spell scroll bears the words of a single spell, written in a mystical cipher. If the spell is on your class''s spell list, you can read the scroll and cast its spell without providing any material components. Otherwise, the scroll is unintelligible. Casting the spell by reading the scroll requires the spell''s normal casting time. Once the spell is cast, the words on the scroll fade, and it crumbles to dust. If the casting is uninterrupted, the scroll is not lost. If the spell is on your class''s spell list but of a higher level than you can normally cast, you must make an ability check using your spellcasting ability to determine whether you cast it successfully. The DC equals 10 + the spell''s level. On a failed check, the spell disappears from the scroll with no other effect. This scroll contains a cantrip. The spell''s saving throw is 13 and the attack bonus is +5.', 0.0, 0, 
    false, NULL, NULL, false, 
    false, NULL, NULL,
    NULL, NULL, 'common',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Spellguard Shield', 'Armor (shield), very rare (requires attunement) While holding this shield, you have advantage on saving throws against spells and other magical effects, and spell attacks have disadvantage against you.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, '{offhand}', NULL,
    NULL, NULL, 'very_rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Staff of Frost', 'Staff, very rare (requires attunement by a druid, sorcerer, warlock, or wizard) You have resistance to cold damage while you hold this staff. The staff has 10 charges. While holding it, you can use an action to expend 1 or more of its charges to cast one of the following spells from it, using your spell save DC: cone of cold (5 charges), fog cloud (1 charge), ice storm (4 charges), or wall of ice (4 charges). The staff regains 1d6 + 4 expended charges daily at dawn. If you expend the last charge, roll a d20. On a 1, the staff turns to water and is destroyed.', 0.0, 0, 
    false, NULL, NULL, false, 
    true, NULL, NULL,
    NULL, NULL, 'very_rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Staff of Swarming Insects', 'Staff, very rare (requires attunement by a bard, cleric, druid, sorcerer, warlock, or wizard) This staff has 10 charges and regains 1d6 + 4 expended charges daily at dawn. If you expend the last charge, roll a d20. On a 1, a swarm of insects consumes and destroys the staff, then disperses. ***Spells.*** While holding the staff, you can use an action to expend some of its charges to cast one of the following spells from it, using your spell save DC: giant insect (4 charges) or insect plague (5 charges). ***Insect Cloud.*** While holding the staff, you can use an action and expend 1 charge to cause a swarm of harmless flying insects to spread out in a 30-foot radius from you. The insects remain for 10 minutes, making the area heavily obscured for creatures other than you. The swarm moves with you, remaining centered on you. A wind of at least 10 miles per hour disperses the swarm and ends the effect.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, NULL, NULL,
    NULL, NULL, 'very_rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Stone of Good Luck (Luckstone)', 'Wondrous item, uncommon (requires attunement) While this polished agate is on your person, you gain a +1 bonus to ability checks and saving throws.', 0.0, 0, 
    false, NULL, NULL, false, 
    true, NULL, NULL,
    NULL, NULL, 'uncommon',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Talisman of the Sphere', 'Wondrous item, legendary (requires attunement) When you make an Intelligence (Arcana) check to control a sphere of annihilation while you are holding this talisman, you double your proficiency bonus on the check. In addition, when you start your turn with control over a sphere of annihilation, you can use an action to levitate it 10 feet plus a number of additional feet equal to 10 × your Intelligence modifier.', 0.0, 0, 
    false, NULL, NULL, false, 
    true, NULL, NULL,
    NULL, NULL, 'legendary',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Universal Solvent', 'Wondrous item, legendary This tube holds milky liquid with a strong alcohol smell. You can use an action to pour the contents of the tube onto a surface within reach. The liquid instantly dissolves up to 1 square foot of adhesive it touches, including sovereign glue.', 0.0, 0, 
    false, NULL, NULL, false, 
    false, NULL, NULL,
    NULL, NULL, 'legendary',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Vicious Weapon', 'Weapon (any), rare When you roll a 20 on your attack roll with this magic weapon, your critical hit deals an extra 2d6 damage of the weapon''s type.', 0.0, 0, 
    true, NULL, NULL, true, 
    false, '{mainhand,offhand,twohand}', NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Wand of Binding', 'Wand, rare (requires attunement by a spellcaster) This wand has 7 charges for the following properties. It regains 1d6 + 1 expended charges daily at dawn. If you expend the wand''s last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed. ***Spells.*** While holding the wand, you can use an action to expend some of its charges to cast one of the following spells (save DC 17): hold monster (5 charges) or hold person (2 charges). ***Assisted Escape.*** While holding the wand, you can use your reaction to expend 1 charge and gain advantage on a saving throw you make to avoid being paralyzed or restrained, or you can expend 1 charge and gain advantage on any check you make to escape a grapple.', 0.0, 0, 
    false, NULL, NULL, false, 
    true, NULL, NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Wand of Magic Detection', 'Wand, uncommon This wand has 3 charges. While holding it, you can expend 1 charge as an action to cast the detect magic spell from it. The wand regains 1d3 expended charges daily at dawn.', 0.0, 0, 
    false, NULL, NULL, true, 
    false, '{spellfocus}', NULL,
    NULL, NULL, 'uncommon',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Wand of Secrets', 'Wand, uncommon The wand has 3 charges. While holding it, you can use an action to expend 1 of its charges, and if a secret door or trap is within 30 feet of you, the wand pulses and points at the one nearest to you. The wand regains 1d3 expended charges daily at dawn.', 0.0, 0, 
    false, NULL, NULL, false, 
    false, NULL, NULL,
    NULL, NULL, 'common',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Wand of the War Mage, +1, +2, or +3', 'Wand, uncommon (+1), rare (+2), or very rare (+3) (requires attunement by a spellcaster) While holding this wand, you gain a bonus to spell attack rolls determined by the wand''s rarity. In addition, you ignore half cover when making a spell attack.', 0.0, 0, 
    false, NULL, NULL, false, 
    true, NULL, NULL,
    NULL, NULL, 'common',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Wand of the War Mage, +1', 'Wand, uncommon (requires attunement by a spellcaster) While holding this wand, you gain a +1 bonus to spell attack rolls. In addition, you ignore half cover when making a spell attack.', 0.0, 0, 
    false, NULL, NULL, false, 
    true, NULL, NULL,
    NULL, NULL, 'uncommon',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Wand of the War Mage, +2', 'Wand, rare (requires attunement by a spellcaster) While holding this wand, you gain a +2 bonus to spell attack rolls. In addition, you ignore half cover when making a spell attack.', 0.0, 0, 
    false, NULL, NULL, false, 
    true, NULL, NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Wand of the War Mage, +3', 'Wand, very rare (requires attunement by a spellcaster) While holding this wand, you gain a +3 bonus to spell attack rolls. In addition, you ignore half cover when making a spell attack.', 0.0, 0, 
    false, NULL, NULL, false, 
    true, NULL, NULL,
    NULL, NULL, 'very_rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Weapon, +1, +2, or +3', 'Weapon (any), uncommon (+1), rare (+2), or very rare (+3) You have a bonus to attack and damage rolls made with this magic weapon. The bonus is determined by the weapon''s rarity.', 0.0, 0, 
    true, NULL, NULL, true, 
    false, '{mainhand,offhand,twohand}', NULL,
    NULL, NULL, 'common',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Weapon, +1', 'Weapon (any), uncommon You have a +1 bonus to attack and damage rolls made with this magic weapon.', 0.0, 0, 
    true, NULL, NULL, true, 
    false, '{mainhand,offhand,twohand}', NULL,
    NULL, NULL, 'uncommon',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Weapon, +2', 'Weapon (any), rare You have a +2 bonus to attack and damage rolls made with this magic weapon.', 0.0, 0, 
    true, NULL, NULL, true, 
    true, '{mainhand,offhand,twohand}', NULL,
    NULL, NULL, 'rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Weapon, +3', 'Weapon (any), very rare You have a +3 bonus to attack and damage rolls made with this magic weapon.', 0.0, 0, 
    true, NULL, NULL, true, 
    false, '{mainhand,offhand,twohand}', NULL,
    NULL, NULL, 'very_rare',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Winged Boots', 'Wondrous item, uncommon (requires attunement) While you wear these boots, you have a flying speed equal to your walking speed. You can use the boots to fly for up to 4 hours, all at once or in several shorter flights, each one using a minimum of 1 minute from the duration. If you are flying when the duration expires, you descend at a rate of 30 feet per round until you land. The boots regain 2 hours of flying capability for every 12 hours they aren''t in use.', 0.0, 0, 
    false, NULL, NULL, true, 
    true, NULL, NULL,
    NULL, NULL, 'uncommon',
    false, NULL
...
INSERT INTO item_catalog (
    ...
    gen_random_uuid(), 'Wings of Flying', 'Wondrous item, rare (requires attunement) While wearing this cloak, you can use an action to speak its command word. This turns the cloak into a pair of bat wings or bird wings on your back for 1 hour or until you repeat the command word as an action. The wings give you a flying speed of 60 feet. When they disappear, you can''t use them again for 1d12 hours.', 0.0, 0, 
    false, NULL, NULL, false, 
    true, NULL, NULL,
    NULL, NULL, 'rare',
    false, NULL
